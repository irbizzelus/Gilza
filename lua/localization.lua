Hooks:Add('LocalizationManagerPostInit', 'Gilza_localizations', function(loc)
	...
	local function AddEnglishLoc()
		...
		LocalizationManager:add_localized_strings({
			...
			menu_sociopathinfil_1_desc = "While you are surrounded by three or more enemies within ##18m## of you, you receive a ##12%## damage reduction. This damage reduction lingers for ##6## seconds after you are no longer surrounded.\n\nYour second and each consecutive melee hit within ##4## seconds of the last one will deal ##100%## more damage.\n",
			...
			menu_deck8_1_desc = "While you are within ##18m## of an enemy, you receive a ##8%## damage reduction. This damage reduction lingers for ##6## seconds after you are no longer close to an enemy.",
			menu_deck8_3_desc = "While you are within ##18m## of an enemy, you receive an additional ##8%## damage reduction. This damage reduction lingers for ##6## seconds after you are no longer close to an enemy.",
		...
		LocalizationManager:add_localized_strings({
			...
			-- Enforcer
			-- E1
			menu_underdog_beta_desc = "BASIC: ##$basic;##\nWhile you are surrounded by three or more enemies within ##18m## of you, you receive a ##10%## damage bonus. This bonus lingers for ##6## seconds after you are no longer surrounded.\n\nACE: ##$pro;##\nWhile you are surrounded by three or more enemies within ##18m## of you, you also receive a ##10%## damage reduction. This damage reduction lingers for ##6## seconds after you are no longer surrounded.\n\nNote: Does not apply to melee damage, throwables, grenade launchers or rocket launchers.",
