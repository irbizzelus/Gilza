Hooks:Add('LocalizationManagerPostInit', 'Gilza_localizations', function(loc)
	...
	local function AddEnglishLoc()
		...
		LocalizationManager:add_localized_strings({
			...
			menu_deck10_9_desc = "Ammo packs you pick up will now also grant you dodge chance. Maximum dodge chance you can get from this perk card is ##35%##. Your chances of getting positive/negative bonuses are shared with this perk deck's first card.\n\nOn a successful roll you gain random amount of dodge chance: from ##2%## to ##8%##. On a successful jackpot, your dodge chance bonus from this perk card is set to the maximum.\nOn a failure roll you will loose a random amount of dodge chance: from ##4%## to ##16%##. On a failure jackpot your bonus dodge chance from this perk card is reset to ##0%##.\n\nDeck Completion Bonus: Your chance of getting a higher quality item during a Payday is increased by ##10%##.\n\nNote: new HUD icon that appears while using Gambler will now also show bonus dodge chance that this perk card provides.",
			-- Hitman
