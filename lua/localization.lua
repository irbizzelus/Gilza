		...
		local function Skill_strings()
			...
			local function Technician_str()
				LocalizationManager:add_localized_strings({
					...
					menu_heavy_impact_beta_desc = "BASIC: ##$basic##\nYour shots can now stagger all enemies, except Bulldozers and Captain Winters, knocking them down. Your base stagger chance is ##5%##, which is then multiplied by the ##threat modifier##.\n\nACE: ##$pro##\nIncreases your base stagger chance to ##20%##.\n\nNote: ##Threat modifier## scales with your weapons' threat level. While using a weapon with ##0## threat, your threat modifier is equal to ##1x##, but it can be increased up to ##3x## if you use a weapon with ##40## or higher threat.",
					...
					menu_shock_and_awe_beta_desc = "BASIC: ##$basic;##\nYou can now hip-fire with your weapons while sprinting.\n\nACE: ##$pro;##\nWhile using SMGs, LMGs, Assault Rifles, Miniguns in automatic or burst fire mode, or while using Flamethrowers:\n\n- Killing ##4## enemies increases your reload speed. Reload speed bonus starts at ##10%##, and is increased by ##1%## for each bullet that you have fired before initiating the reload. Reload speed bonus maxes out at ##125%##.\n- Landing ##3## hits on enemies within ##1## second(s) refills ##1## bullet directly into your magazine, without consuming your ammo reserves.\n\nNote: Swapping weapons resets kill, bullets fired and hit counters. Canceling the reload resets the kill requirement and bullets fired counter.",
		...
		local function Skill_strings()
			...
			local function Technician_str()
				LocalizationManager:add_localized_strings({
					...
					menu_shock_and_awe_beta_desc = "БАЗОВЫЙ: ##$basic;##\nСтрельба на бегу: вы можете стрелять от бедра во время бега.\n\nПРО: ##$pro;##\nПри использовании Пистолет-Пулеметов, Пулеметов, Штурмовых Винтовок и Миниганов в режиме автоматической или очередной стрельбы, или при использовании огнеметов:\n\n- После убийства ##4## противников скорость вашей перезарядки будет увеличена. Минимальный бонус к скорости перезарядки равен ##10%##, и за каждую выстреленную вами пулю перед началом перезарядки данный бонус увеличивается на ##1%##. Максимальный бонус перезарядки данного навыка равен ##125%##.\n- Совершив ##3## попадания по врагам в пределах ##1## секунды, магазин вашего оружия будет пополнен на ##1## пулю, не расходуя ваш общий боезапас.\n\nПометка: При смене оружия счетчики убийств, выстреленных пуль и попаданий сбрасываются. При отмене перезарядки счетчики убийств и выстреленных пуль сбрасываются.",
