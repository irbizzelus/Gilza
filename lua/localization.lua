		...
		local function Perk_strings_vanilla()
			...
			local function Leech_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck22_7_desc = "Your maximum health is increased by ##20%##.\n\nAfter you revive a crew member, or you get revived by any means, your Leech Ampule cooldown is reduced by ##15## seconds. Reviving yourself with the Leech Ampule does not activate this skill.",
		...
		local function Perk_strings_vanilla()
			...
			local function Leech_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck22_7_desc = "Ваше здоровье увеличено на ##20%##.\n\nКулдаун Ампулы будет сокращен на ##15## секунд если вы поднимите союзника, если вы были подняты союзником, или вы поднялись сами по себе. Если вы подняли сами себя на ноги используя Ампулу, данный навык не активируется.",
