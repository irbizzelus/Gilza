Hooks:Add('LocalizationManagerPostInit', 'Gilza_localizations', function(loc)
	...
	local function AddEnglishLoc()
		...
		LocalizationManager:add_localized_strings({
			...
			menu_deck8_5_desc = "While you are within ##18m## of an enemy, you receive an additional ##7%## damage reduction. This damage reduction lingers for ##5## seconds after you are no longer close to an enemy.",
			menu_deck8_7 = "Expert Close Combat",
			menu_deck8_7_desc = "While you are within ##18m## of an enemy, you receive an additional ##7%## damage reduction. This damage reduction lingers for ##5## seconds after you are no longer close to an enemy.",
			-- grinder
