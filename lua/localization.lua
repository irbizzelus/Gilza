Hooks:Add('LocalizationManagerPostInit', 'Gilza_localizations', function(loc)
	...
	local function AddEnglishLoc()
		...
		LocalizationManager:add_localized_strings({
			...
			menu_deck13_7_desc = "Increases the amount of health stored from kills by ##4##.\n\nYou gain ##20%## more health.\n\nIf you were to take health damage while having stored health, stored health will take ##1.5x## of incoming damage instead of your health.\nIf incoming damage is greater then your stored health, you loose all of your stored health and the remaining damage is ignored.",
			menu_deck13_9_desc = "For each kill you or your crew performs, your next armor recovery timer will be reduced by a few centiseconds. Timer reduction depends on your equpped armor - higher armor equppied provides smaller timer bonus. Your armor recovery speed can not be faster then ##0.25## seconds total with this skill.\nArmor recovery timer bonus is reset when your armor fully recovers.\n\nArmor recovery timer bonus gain based on equipped armor:\nSuit - ##0.26##\nLBV - ##0.22##\nBV - ##0.2##\nHBV - ##0.18##\nFJ - ##0.12##\nCTV - ##0.1##\nICTV - ##0.05##\n\nDeck Completion Bonus: Your chance of getting a higher quality item during a Payday is increased by ##10%##.",
			-- Gambler
