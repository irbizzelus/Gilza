Hooks:Add('LocalizationManagerPostInit', 'Gilza_localizations', function(loc)
	...
	-- add generic AP strings (or whatever else i might add to this thing later)
	-- strings should already be pre-defined on the language
	if Gilza.strings_to_add then
		for id,str in pairs(Gilza.strings_to_add) do
			LocalizationManager:add_localized_strings({[tostring(id)] = str})
		end
	end
	LocalizationManager:add_localized_strings({bm_wpn_gilza_generic_ap_desc_nil__nil__nil__nil_ = "This attachment does not add any Armor Piercing! No penalties are applied. This message should never be seen - if you do, please report what weapon it happened with :)"})
	...
	local function AddEnglishLoc()
		...
		local function Perk_strings_vanilla()
			...
			local function Neutral_cards()
				LocalizationManager:add_localized_strings({
					...
					menu_deckall_6_desc = "Unlocks an armor bag equipment for you to use. The armor bag can be used to change your armor during a heist.\n\nYou gain an ability to pick up throwables from ammo packs. You start at ##0## ammo pickups and get ##+1## for every ammo box you pick up. After reaching a \"pick up target\" you refill ##1## throwable and your pick up counter is reset to ##0##. Pick up targets are different for every throwable and can be found in their descriptions.",
			...
			local function Rogue_str()
				LocalizationManager:add_localized_strings({
					menu_deck4_9_desc = "Your chance to dodge while crouched is increased by ##5%##.\n\nYou gain ##40%## chance to pierce enemy body armor.\nYour weapon swapping speed is increased by ##33%##.\n\nYour movement speed is increased by ##10%## and stamina is increased by ##25%##.\n\nDeck Completion Bonus: Your chance of getting a higher quality item during a Payday is increased by ##10%##.",
					-- short descs
					menu_deck4_9_short = "Your chance to dodge while crouched is increased by ##5%##. You gain ##40%## chance to pierce enemy body armor. Your weapon swapping speed is increased by ##33%##. Your movement speed is increased by ##10%## and stamina is increased by ##25%##.",
				})
			end
			Rogue_str()
			...
			local function Hitman_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck5_1_desc = "Securing a kill with a melee weapon or a throwable non-explosive weapon regenerates ##20%## of your armor.\n\nYou gain ##5%## more armor.",
					...
					menu_deck5_5_short = "New ability: Rhythm of Death. Securing ##4## perfectly timed combo kills in a row grants ##8-12## seconds of invulnerability, with a ##30## second cooldown. Combo requires a melee or throwable non-explosive weapon kill to begin.",
			...
			local function Crook_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck6_9_short = "Your armor recovery rate is increased by ##10%##. You gain ##75%## chance to pierce enemy body armor.",
				})
			end
			Crook_str()
			...
			local function Yakuza_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck12_9_short = "All perk deck effects that activate while ##<25%## health, will now activate while ##<50%##. While your health is below ##50%## you are immune to armor suppression effect.",
				})
			end
			Yakuza_str()
			...
			local function Ex_president_str()
				LocalizationManager:add_localized_strings({
					menu_deck13_1_desc = "While your armor is up, you get ##4## stored health for each enemy you or your crew kills.\nMaximum amount of stored health depends on equipped armor, exact values can be found in armor descriptions.\n\nAfter your armor has been depleted to 0, following armor recovery will also activate primary health healing, using the stored health you got.\nStored health is used to recover as much missing primary health as possible, and if any stored health is remaining after the heal, stored health amount is further reduced by ##48## points.",
					menu_deck13_3_desc = "Increases amount of stored health gained on kill by ##4##.\n\nYou gain ##10%## more primary health.",
					menu_deck13_5_desc = "Your maximum stored health capacity is increased by ##50%##.\n\nYou gain ##10%## more primary health.\n\nYou now have ##20%## static dodge chance. Static dodge chance which you gain from this perk card can not be increased or decreased by other skills or by equipping different armors.",
					menu_deck13_7_desc = "Increases amount of stored health gained on kill by ##4##.\n\nYou gain ##20%## more primary health.\n\nIf you were to take damage to your primary health while having any amount of stored health, stored health will absorb incoming damage first.\nIf incoming damage is greater than amount of stored health you have, stored health will absorb damage equal to amount of stored health, and remaining damage will then be applied to your primary health directly.",
					menu_deck13_9_desc = "For each kill you or your crew performs, your armor recovery is sped up by a fraction of a second. Time reduction scales with equipped armor - bigger armors provide smaller time bonuses on kill. Fastest possible armor recovery time you may achieve is ##0.8## seconds.\nArmor recovery speed up bonus is reset whenever stored health is consumed to either heal your primary health, or to protect it from incoming damage.\n\nNotes:\n- Armor recovery rate skills are applied after this skill reduces the armor recovery time.\n- This skill does not affect suppression recovery penalty.\n\nNote: Gilza's perk UI will show your total armor recovery speed, accounting only for the bonuses of this perk skill.\n\nDeck Completion Bonus: Your chance of getting a higher quality item during a Payday is increased by ##10%##.",
					...
					-- short descs
					menu_deck13_5_short = "Increases the maximum health that your armor can store by ##50%##. You gain ##10%## more primary health. You now have ##20%## static dodge chance.",
					menu_deck13_7_short = "Increases the amount of health stored from kills by ##4##. You gain ##20%## more primary health. Your stored health can now shield your normal health.",
					menu_deck13_9_short = "For each kill you or your crew performs, your armor recovery time is sped up by a fraction of a second, until your stored health is consumed. Timer reduction depends on your equipped armor - higher armor equipped provides smaller timer bonus.",
				})
			end
			Ex_president_str()
			...
			local function Maniac_str()
				LocalizationManager:add_localized_strings({
					menu_deck14_1_desc = "Any damage you deal is converted into Hysteria Stacks at 1 to 1 ratio, but no more than ##120## every ##1.5## second(s). Max amount of stacks is ##600##.\n\nHysteria Stacks:\nYou gain ##1## damage absorption for every ##30## stacks of Hysteria.\n\nIf you don't deal any damage for ##3## seconds, you will lose ##20% + 80## Hysteria Stacks.",
			...
			local function Hacker_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck21_7_desc = "Killing at least ##3## enemies while the feedback or jamming effect is active will grant ##15## dodge for ##50## seconds.",
					-- short descs
					...
					menu_deck21_7_short = "Killing at least ##3## enemies while the feedback or jamming effect is active will grant ##15## dodge for ##50## seconds.",
				})
			end
			Hacker_str()
			...
			local function Leech_str()
				LocalizationManager:add_localized_strings({
					menu_deck22_1_desc = "Unlocks and equips the Leech Ampule. The Leech Ampule replaces your current throwable, is equipped in your throwable slot and can be switched out if desired. While in game you can use ##$BTN_ABILITY;## to activate the Leech Ampule.\nThe Leech Ampule lasts for ##6## seconds with a ##60## seconds cooldown. If you go down while your Leech Ampule is ready or it's cooldown is lower than ##20## seconds, the cooldown will be increased to ##20## seconds.\n\nActivating the Leech Ampule restores ##50%## health. While the Leech Ampule is active your armor is disabled and your health is divided into segments of ##25%##. Taking damage removes one health segment, but if damage was greater than 150, two health segments will be removed instead.\nUpon losing a segment you enter Preservative state for ##1## second(s), granting you damage invulnerability. Securing a kill during this state will recover ##1## health segment, but no more than once during a single Preservative period. Recovering a health segment this way also heals your teammates for ##5%## of their health. For every additional Leech player on your team, the team heal bonus is reduced by ##25%##.\nIf you revive a teammate while the Leech Ampule is active, you will recover ##50%## of your health and ##100%## of your armor immediately after the Leech Ampule effect ends.",
					menu_deck22_3_desc = "Your maximum health is increased by ##20%##.\n\nWhile the Leech Ampule is active you cannot go into bleedout, but reaching ##0## health forces you into Last Breath state which slows you down by ##80%##, disables healing from all skills, disables automatic revive from \"Uppers\" Aced skill, and disables your ability to heal with First Aid Kits and Doctor Bags. Securing a kill while in the Preservative state is the only way you can heal while in the Last Breath state.\n\nIf Leech Ampule effect ends while you are in the Last Breath state, you will automatically go down, unless you have revived a teammate during the Leech Ampule effect duration.",
					menu_deck22_5_desc = "The Leech Ampule duration is increased to ##10## seconds.\n\nKilling an enemy reduces the cooldown of the Leech Ampule by ##1## second(s).\n\nRecovering health segments during the Preservative state now heals teammates for ##10%## of their health.\n\nReviving a crew member heals them for ##20%## of their health, and heals you for ##10%## of your health.\nNote: teammates may receive healing up to 4 seconds after they were revived, depending on their ping.",
					menu_deck22_7_desc = "Your maximum health is increased by ##60%##.\n\nYour Leech Ampule cooldown is reduced by ##10## seconds whenever:\n- You revive a crew member\n- You get revived by any means\n- Your Leech Ampule effect ends, but only if you have revived a crew member during the Ampule effect duration",
					menu_deck22_9_desc = "You can now activate Leech Ampule while downed, temporarily reviving yourself until the end of the Leech Ampule. Doing so inflicts additional ##40## seconds of cooldown to the Leech Ampule.\nNote: Reviving yourself with the Leech Ampule does not activate cooldown reduction skill from the \"Built Different\" perk card.\n\nAfter reviving yourself with the Leech Ampule, you may stay alive after the Ampule effect ends, if you either successfully use a doctor bag and maintain more than ##0## health afterwards, or successfully revive a teammate.\n\nWhile the Leech Ampule is active your health is now divided into segments of ##20%##. Securing a kill during the Preservative period will now restore ##2## health segments instead of ##1##, and your teammates will get healed for ##20%## of their health instead of ##10%##.\n\nDeck Completion Bonus: Your chance of getting a higher quality item during a Payday is increased by ##10%##.",
					-- short descs
					menu_deck22_1_short = "Unlocks and equips the Leech Ampule throwable, which restores health, disables your armor, and divides your health into segments. Taking damage removes segment(s). When segment is removed you gain invulnerability. If you secure a kill during invulnerability period you will restore a health segment and heal your teammates. Reviving teammates refills armor and health after Leech Ampule ends.",
					menu_deck22_5_short = "The Leech Ampule duration is increased. Killing an enemy reduces Leech Ampule cooldown. Recovering health segments heals more health for your teammates.",
					menu_deck22_7_short = "You gain more health and Leech Ampule cooldown is reduced every time you revive a teammate or you are revived.",
			...
			local function Copycat_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck23_1_4_desc = "Your crouched and carry movement speed is increased by ##10%##. Your total ammo capacity is increased by ##5%##.",
					menu_deck23_3_4_desc = "Your crouched and carry movement speed is increased by ##10%##. Your total ammo capacity is increased by ##5%##.",
					menu_deck23_5_4_desc = "Your crouched and carry movement speed is increased by ##10%##. Your total ammo capacity is increased by ##5%##.",
					menu_deck23_7_4_desc = "Your crouched and carry movement speed is increased by ##10%##. Your total ammo capacity is increased by ##5%##.",
					-- 9th card bonuses
					...
					menu_deck23_9_yakuza_desc = "The lower your health, the more movement speed you gain. When your health is below ##50%##, you will gain up to ##20%## movement speed.\n\nYour armor can no longer be penetrated by armor piercing ammunition while your health is below ##50%##.\nWhile your health is below ##50%## you are immune to armor suppression effect.\n\nNote: normally, armor suppression effect is applied to you whenever you are shot, regardless of if you are hit or not. If you get suppressed, your armor recovery timer will be set to it's maximum duration and additional ##1## second will be added from armor suppression effect to your total recovery timer. This addition is not affected by armor recovery or any other skills.\nArmor suppression immunity effect from this perk card reduces this timer extension to ##0.5## seconds, and also disables your armor recovery timer from resetting to it's maximum duration when you are being shot at, without getting hit.",
					menu_deck23_9_expres_desc = "While your armor is up, you will store ##8## health for every ##1## enemy you or your crew kills.\n\nWhen your armor has been completely depleted and then finishes it's recovery, you will gain health equal to the stored health amount. Regardless of how much stored health was used to regain your health, stored health will always reset to ##0## after your armor recovers.\n\nMaximum amount of stored health depends on your equipped armor, and can be found in armor descriptions.\n\nYou gain ##10%## more health.",
					menu_deck23_9_maniac_desc = "Any damage you deal is converted into Hysteria Stacks at 1 to 1 ratio, but no more than ##120## every ##1.5## second(s). Max amount of stacks is ##600##.\n\nHysteria Stacks:\nYou gain ##1## damage absorption for every ##30## stacks of Hysteria.\n\nIf you don't deal any damage for ##3## seconds, you will lose ##20% + 80## Hysteria Stacks.\n\nMembers of your crew also gain the effect of your Hysteria Stacks.\n\nHysteria Stacks from multiple crew members do not stack and only the stacks that gives the highest damage absorption will have an effect.",
					...
					menu_deck23_9_biker_desc = "Every time you or your crew performs a kill, 1 Stack of Regeneration can be received. When received, Stack of Regeneration instantly restores ##4## health and ##4## armor and then activates it's ##6## second cooldown, after which this stack will be removed.\n\nYou have a maximum of ##4## Stack of Regeneration slots. New Stacks of Regeneration can not be added if your Stack of Regeneration slots are full. New Stacks of Regeneration will not be added if both your armor and health are full.\n\nWhile you have any amount of armor remaining, upon receiving a Stack of Regeneration, you will also receive a ##1## second Overstack Prevention cooldown.\nWhile Overstack Prevention cooldown is active, you can not receive additional Stacks of Regeneration unless your armor is completely broken.",
					menu_deck23_9_stoic_desc = "Unlocks and equips the Stoic Hip Flask.\n\nChanging to another perk deck will make the Stoic Hip Flask unavailable again. The Stoic Hip Flask replaces your current throwable, is equipped in your throwable slot and can be switched out if desired.\n\nDamage taken is now reduced by ##50%##. The remaining damage will be applied directly.\n\nThe ##50%## reduced damage will be applied over-time (##10## seconds) instead.\n\nYou can use the throwable key ##$BTN_ABILITY;## to activate the Stoic Hip Flask and immediately negate any pending damage. The flask has a ##10## second cooldown, but time remaining will be lessened by ##1## second per enemy killed.",
					menu_deck23_9_leech_desc = "Unlocks and equip the Leech Ampule, replacing your current throwable. After activating using ##$BTN_ABILITY;## the Ampule will last for ##6## seconds with a ##60## seconds cooldown. If you go down while your Ampule is ready or it's cooldown is lower than ##20## seconds, the cooldown will be increased to ##20## seconds.\nActivating the Ampule restores ##50%## health. While the Ampule is active your armor is disabled and your health is divided into segments of ##25%##. Taking damage removes one health segment, but if damage was greater than 150, two health segments will be removed instead. Upon losing a segment you enter preservative state for ##1## second(s), granting you damage invulnerability. Securing a kill during this state will recover ##1## health segment - this can only occur once during a single preservative period. Recovering a health segment during the preservative period also heals your teammates for ##5%## of their health. For every additional Leech player on your team, this team heal bonus is reduced by ##25%##. If you revive a teammate while the Ampule is active, you will recover ##50%## of your health, ##100%## of your armor and reduce Ampule cooldown by ##10## seconds after the Ampule effect ends. After you revive a crew member, or you get revived by any means, your Ampule cooldown is reduced by ##10## seconds.",
					menu_deck23_9_brawler_desc = "You can now receive up to ##3## armor regeneration stacks. If you have no armor regeneration stacks active, you can activate the first one by securing a kill by any means. To get multiple simultaneous stacks you need to secure additional kills with melee weapons or the OVE9000 Saw.\nA single stack regenerates ##20## points of armor over the period of ##10## seconds. Each stack regenerates armor in increments of total amount once every ##2.5## second(s).\nTotal armor regeneration from one stack is increased to ##50## while playing on Death Sentence difficulty.\n\nNote: Gilza's perk UI will show you how many regeneration effects you currently have as \"1x\" text under the icon.",
					menu_deck23_9_junkie = "Speed Junkie",
					menu_deck23_9_junkie_desc = "You can now obtain up to ##100## adrenaline stacks by moving. Moving at high speeds will add adrenaline stacks to your meter - higher your speed, more stacks you gain. If you don't move quickly enough, your adrenaline stacks will begin to deplete.\n\nFor every adrenaline stack you have you gain a chance to dodge, up to ##45%## maximum dodge chance at ##100## stacks.\n\nIf you maintain ##90## or more stacks of adrenaline for longer than ##3## seconds you will become exhausted. Becoming exhausted completely depletes your stamina and some of your adrenaline stacks.\n\nYou can recover your armor only when you stand still.\n\nGilza's perk UI will show your current amount of adrenaline stacks, if you have too much adrenaline (red) and if you are exhausted (purple).",
		...
		local function Perk_strings_custom()
			...
			local function Brawler_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck_brawler1_desc = "Your armor recovery rate is reduced by ##350%##.\n\nYour ammo capacity is reduced by ##80%##. Note that this reduction is applied after all other ammo related skills, as a ##0.2## multiplier, which means you can't effectively counter this effect with other skills.\n\nYou can no longer pick up ammo boxes droped by enemies, but instead, after receiving enough instances of melee or bullet damage, you will now receive an equivalent of ##1## ammo box dropped by enemies, which includes cable ties (randomly), throwables (at a standard rate) and weapon ammo (at a reduced by ##80%## rate; acts as a ##0.2## multiplier, meaning it can't be countered with other skills).\nIf you are using bows or crossbows, you only have a ##20%## chance for bolts to return when you try to pick them up.\n\nYour melee weapons can now deal bonus headshot damage.\n\nWhile using melee weapons your armor gains ##5%## bullet damage resistance.",
					menu_deck_brawler3 = "Flexibility improvements",
					menu_deck_brawler3_desc = "While using melee weapons your armor gains ##5%## more bullet damage resistance.\n\nBody armor movement speed penalty is reduced by additional ##25%##.",
					menu_deck_brawler5 = "Armor plate upgrade",
					menu_deck_brawler5_desc = "Your armor can no longer be penetrated by armor piercing ammunition.\n\nWhile using melee weapons your armor gains ##10%## more bullet damage resistance.\n\nBody armor movement speed penalty is reduced by additional ##25%##.\n\nSecuring a kill with a melee weapon restores ##5%## of your stamina.",
					menu_deck_brawler7 = "Meat shield",
					menu_deck_brawler7_desc = "While you are under ##50%## health, your armor gains ##4%## bullet damage resistance for every teammate within ##21m## from you. This bonus can stack up to ##3## times.\nEnemies that you have converted to fight on your side count as teammates for this mechanic.\nWhile playing on Death Sentence difficulty, damage resistance bonus from this perk card is increased to ##8%## per teammate.\n\nYou are ##15%## more likely to be targeted when you are close to your crew members. All other skills that adjust your likelihood of being targeted are now ignored.\n\nNote: Gilza's perk UI will show you how many teammates you currently have around you: icon will be faded out for 0 players, colored white for 1, yellow for 2, and green for 3.",
					menu_deck_brawler9 = "Bloodlusty kevlar",
					menu_deck_brawler9_desc = "Securing a kill with a melee weapon instantly regenerates ##40## points of armor. While playing on Death Sentence difficulty regeneration amount is increased to ##120##.\n\nYou can now receive up to ##3## armor regeneration stacks. If you have no armor regeneration stacks active, you can activate the first one by securing a kill by any means. To get multiple simultaneous stacks you need to secure additional kills with melee weapons or the OVE9000 Saw.\nA single stack regenerates ##40## points of armor over the period of ##10## seconds. Each stack regenerates armor in increments of total amount once every ##2## second(s).\nTotal armor regeneration from one stack is increased to ##120## while playing on Death Sentence difficulty.\n\nDeck Completion Bonus: Your chance of getting a higher quality item during a Payday is increased by ##10%##.\n\nNote: Gilza's perk UI will show you how many regeneration effects you currently have as \"1x\" text under the icon.",
					-- short descs
					menu_deck_brawler1_desc_short = "Your ammo capacity and pick up rate are reduced by ##80%##. Your armor recovery rate is reduced by ##350%##. Your armor gains bullet damage resistance while using melee. Your melee weapons can deal headshot bonus damage.",
					menu_deck_brawler3_desc_short = "Your armor has more bullet damage resistance while using melee and it's movement speed penalty is reduced.",
					menu_deck_brawler5_desc_short = "Your armor is now immune to the AP effect, it has more bullet damage resistance while using melee, and it's movement penalty is reduced even more. Melee kills restore stamina.",
					...
					menu_deck_brawler9_desc_short = "Melee kills provide both instant and over time armor regeneration.",
				})
			end
			Brawler_str()
			...
			local function Speed_Junkie_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck_SJ_1_desc = "You can now obtain up to ##100## adrenaline stacks by moving. Moving at high speeds will add adrenaline stacks to your meter - higher your speed, more stacks you gain. If you don't move quickly enough, your adrenaline stacks will begin to deplete. Adrenaline stack depletion is prevented during interactions.\n\nFor every adrenaline stack you have you gain a chance to dodge, up to ##45%## maximum dodge chance at ##100## stacks.\n\nIf you maintain ##90## or more stacks of adrenaline for longer than ##3## seconds you will become exhausted. Becoming exhausted completely depletes your stamina and some of your adrenaline stacks.\n\nYou can recover your armor only when you stand still.\n\nYou convert ##90%## of your health to ##42%## of armor.\n\nGilza's perk UI will show your current amount of adrenaline stacks, if you have too much adrenaline (red) and if you are exhausted (purple).",
					...
					menu_deck_SJ_5_desc = "Securing a kill adds ##5-20## stacks of adrenaline - lower your adrenaline meter is, higher the stack gain.\nSecuring a kill while your adrenaline stack amount is higher than ##90## will bring your adrenaline stacks down to ##90##.\n\nNew ability: adrenaline spike.\nWhile your adrenaline stack amount is over ##70## you gain ##1## adrenaline spike point every second. When your reach ##40## adrenaline spike points, you become eligible for an adrenaline spike. While you are eligible for an adrenaline spike you have a ##10%## chance to activate it by securing a kill by any means. Adrenaline spike overdoses your adrenaline stacks for ##12## seconds. After adrenaline spike is over you become exhausted and your adrenaline spike points are reset to ##0##.\n\nYou convert ##90%## of your health to ##52%## of armor.",
					...
					-- short descs
					menu_deck_SJ_1_desc_short = "Unlocks adrenaline stacks, earned for quick movement. Stacks provide up to ##45%## dodge. You can recover your armor only when you stand still. Convert ##90%## health for ##42%## armor.",
					menu_deck_SJ_3_desc_short = "Gain ##15%## dodge. Kills refill ##8%## stamina. Convert ##90%## health for ##46%## armor.",
					menu_deck_SJ_5_desc_short = "Kills provide adrenaline stacks. Convert ##90%## health for ##52%## armor. New ability: adrenaline spike.",
			...
			local function Guardian_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck_Gilza_guardian_7_desc = "For every ##10## armor points your equipped armor has, you gain a ##3%## chance for any taken bullet damage to be mirrored back at the enemy who damaged you. Note that you still take damage whenever this effect is triggered.\n\nIt now only takes ##3## seconds of standing still to activate a defensive area.",
		...
		local function Skill_strings()
			...
			local function Mastermind_str()
				LocalizationManager:add_localized_strings({
					...
					menu_speedy_reload_beta_desc = "BASIC: ##$basic##\nYour reload speed with SMGs, Assault Rifles and Sniper Rifles is increased by ##20%##.\n\nSecuring a bodyshot kill with an SMG, Assault Rifle or a Sniper Rifle in single shot fire mode, refills ##10%## of a standard ammo pick up for both of your weapons. This does not affect grenade pick up skills.\n\nACE: ##$pro##\nBodyshot kills in single shot fire mode now refill ##40%## of a standard ammo pick up.\n\nSecuring a bodyshot kill with an SMG, Assault Rifle or a Sniper Rifle in single shot fire mode, will increase reload speed with all weapons by ##7.5%##, stacking up to ##75%##. Securing a kill after a reload will reset this bonus to ##0%##.",
					menu_sniper_graze_damage_desc = "BASIC: ##$basic##\nSingle-shot fire mode shots with Sniper Rifles, Assault Rifles and SMGs start with a ##30cm## Grazing radius around the bullet trajectory, making hits easier.\n\nAfter hitting an enemy, the Grazing radius gets increased by ##30cm##, but the Grazing damage gets reduced by ##30%##. Each new enemy hit keeps increasing the radius and reducing the damage, however the damage reduction will stop whenever it reaches ##20%## of the original damage.\n\nNotes:\n- If no new enemy is Grazed within ##5m## after the previous hit, Grazing radius disappears for the rest of the shot.\n- Damage reduction only applies to Grazed enemies - enemies hit directly by the bullet always take full weapon damage.\n- Grazing damage never deals bonus headshot damage.\n- Enemies killed by Grazing damage count as bodyshot kills.\n- Shields are ignored by Graze if used weapon does not have shield penetration capabilities.\n- Enemies behind walls are ignored by Graze if used weapon does not have wall penetration capabilities.\n\nACE: ##$pro##\nInitial Grazing radius is now ##50cm##, radius increase per hit is now ##40cm##, damage loss per hit is now ##20%##, lowest possible Grazing damage is now ##35%##, and Grazing radius now disappears only after ##10m## of no enemy hits.",
				})
			end
			Mastermind_str()
			...
			local function Enforcer_str()
				LocalizationManager:add_localized_strings({
					-- E1
					menu_underdog_beta_desc = "BASIC: ##$basic;##\nWhile you are surrounded by three or more visible enemies within ##18m## of you, you receive a ##10%## damage bonus. This bonus lingers for ##5## seconds after you are no longer surrounded.\n\nACE: ##$pro;##\nWhile you are surrounded by three or more visible enemies within ##18m## of you, you also receive a ##10%## damage resistance. This damage resistance lingers for ##5## seconds after you are no longer surrounded.\n\nNote: Bonus damage does not apply to melee damage, throwables, grenade launchers or rocket launchers.",
			...
			local function Technician_str()
				LocalizationManager:add_localized_strings({
					...
					menu_heavy_impact_beta = "Shockwave",
					menu_heavy_impact_beta_desc = "BASIC: ##$basic##\nWhile using SMGs, LMGs, Assault Rifles and Miniguns in automatic or burst fire mode:\nLanding a hit can stagger other enemies within ##2## meters of the hit target with a ##2.5%## base chance. Each enemy rolls their stagger chance invdividually, but no more than ##1## enemy can be staggered per initial hit. The stagger chance can be increased by your weapon's threat level.\n\nNotes:\n- Bulldozers, Captain Winters and shields are not affected by this skill.\n- Threat level multiplier: while using a weapon with ##0## threat, your threat multiplier is equal to ##1x##, but it can be increased up to ##3x## if you use a weapon with ##40## or higher threat.\n\nACE: ##$pro##\nYour base stagger chance is increased to ##7%## and effective range of the skill is increased to ##4## meters.\n\nUsing the same stagger chances, you can now stagger cloakers with ##direct## bullet hits.",
					menu_fire_control_beta_desc = "BASIC: ##$basic##\nYour ##36## point recoil penalty while firing from the hip is removed.\n\nACE: ##$pro##\nYour ##20## point accuracy penalty while firing from the hip is removed.",
					menu_shock_and_awe_beta_desc = "BASIC: ##$basic;##\nYou can now hip-fire with your weapons while sprinting.\n\nACE: ##$pro;##\nWhile using SMGs, LMGs, Assault Rifles, Miniguns in automatic or burst fire mode, or while using Flamethrowers:\n\n- Killing ##5## enemies increases your reload speed. Reload speed bonus starts at ##10%##, and is increased by ##1%## for each bullet that you have fired before initiating the reload. Reload speed bonus maxes out at ##125%##.\n- Landing ##3## hits on enemies within ##1## second(s) refills ##1## bullet directly into your magazine, without consuming your ammo reserves.\n\nNote: Initiating a reload resets the kill requirement and bullets fired counters. Swapping weapons resets the hits landed counter.",
					menu_fast_fire_beta_desc = "BASIC: ##$basic##\nYour SMGs, LMGs and Assault Rifles gain ##15## more bullets in their magazines.\n\nACE: ##$pro##\nYou gain ##25%## chance to pierce enemy body armor.\n\nBody piercing backup: if your body armor piercing chance succeeds you deal full damage, but if it fails, you would still be able to pierce enemy body armor, but with reduced by ##50%## damage.",
					menu_body_expertise_beta_desc = "BASIC: ##$basic##\nWhile using SMGs, LMGs, Assault Rifles and Miniguns in automatic or burst fire mode or while using Bows, Crossbows, Flamethrowers or the OVE9000 saw:\n- Hitting enemies on the body applies ##100%## of the bonus headshot damage.\nNote: Does not apply to Bulldozers.\n\nACE: ##$pro##\nWhile using the same weapons mentioned above:\n- Hitting enemies on the body now applies ##125%## of the bonus headshot damage.\n- Hitting enemies on the head applies ##125%## of the bonus headshot damage.\nNote: Does not apply to Bulldozers.\n\nBody piercing backup: if your body armor piercing chance succeeds you deal full damage, but if it fails, you would still be able to pierce enemy body armor, but with reduced by ##50%## damage.\nNote: If combined with \"Surefire\" Aced, damage penalty is nullified.",
				})
			end
			Technician_str()
			...
			local function Ghost_str()
				LocalizationManager:add_localized_strings({
					...
					menu_jail_diet_beta_desc = "BASIC: ##$basic##\nWhile your armor is broken you gain ##15## dodge. Successfully dodging while your armor is broken restores ##20## points of armor, but also disables all bonuses of this skill for ##45## seconds.\n\nACE: ##$pro##\nWhile your armor is broken you now gain ##40## dodge, armor restoration on successfull dodge is increased to ##50## points, and skill cooldown is reduced to ##25## seconds.",
					-- G3
			...
			local function Fugitive_str()
				LocalizationManager:add_localized_strings({
					-- F1
					menu_equilibrium_beta_desc = "BASIC: ##$basic;##\nDecreases the time it takes to draw and holster pistols by ##50%##.\n\nWhile holding pistols your movement speed is increased by ##10%##.\n\nACE: ##$pro;##\nYou gain ##16## accuracy with pistols. Your snap to zoom is ##100%## faster with pistols.\n\nYour ##10%## movement speed bonus now applies while having a pistol equipped in your loadout, without the need to hold it.",
					menu_dance_instructor = "Swift Hands",
					menu_dance_instructor_desc = "BASIC: ##$basic##\nYou reload all pistols ##30%## faster.\n\nACE: ##$pro##\nSwapping to your secondary pistol will initiate an offhand reload of your primary weapon at a reduced by ##150%## reload speed.\nThis reload is canceled if you swap to your primary before the offhand reload ends.\n\nHitting enemies with your secondary pistol reduces the offhand reload timer by ##0.2## seconds.",
					menu_gun_fighter_beta = "Trigger happy",
					menu_gun_fighter_beta_desc = "BASIC: ##$basic##\nSuccessful pistol hit activates this skill for ##5## seconds.\nWhile this skill is active you gain a ##32%## increased accuracy with all pistols.\n\nACE: ##$pro##\nWhile this skill is active you now also gain a ##30%## damage boost, and a ##25%## rate of fire increase with all pistols.\n\nYou are the fastest gun in the New West.\nYou can now fire your single-fire mode pistols automatically, by holding down your \"Fire Weapon\" keybind.",
					...
					menu_martial_arts_beta_desc = "BASIC: ##$basic##\nYou are ##50%## more likely to knock down enemies with a melee strike.\n\nYour camera shake and knockback when hit by a melee attack is reduced by ##20%##.\n\nACE: ##$pro##\nYou take ##50%## less damage from all melee attacks.\n\nYour camera shake and knockback when hit by a melee attack is now reduced by ##75%##. Because of training.",
					menu_bloodthirst_desc = "BASIC: ##$basic##\nWhenever you kill an enemy with a melee attack, you will gain a ##35%## increase in reload speed for ##6## seconds.\n\nACE: ##$pro##\nEvery kill you get will increase your next melee attack damage by ##40%##. This effect can stack up to ##5## times.\nThis effect gets reset when you kill an enemy with a melee attack.",
		...
		local function Weapon_strings()
			...
			local function Vanilla_attachs_universal()
				LocalizationManager:add_localized_strings({
					...
					bm_wp_upg_i_burstfire_desc = "Limits weapons' fire mode to 3 round bursts, improving accuracy at the cost of max damage per second.",
					bm_wp_upg_i_burstfire_2rnd_desc = "Limits weapons' fire mode to 2 round bursts, improving accuracy at the cost of max damage per second.",
					bm_wpn_fps_damage_class_update_increase = "Ammo pick up increased to match new damage class.",
					bm_wpn_fps_damage_class_update_decrease = "Ammo pick up decreased to match new damage class.",
					bm_wpn_wallbangless_sniper = "Penetrates body armor, enemies and shields.",
					bm_wp_upg_lmg_lionbipod_desc_pc = "Allows to automatically mantle to walls and objects at 90 or 180 degree angles. Placing the bipod manualy, using the $BTN_BIPOD; key will prevent automatic dismantling.",
				})
			end
			...
			local function Vanilla_attachs_individual()
				LocalizationManager:add_localized_strings({
					...
					bm_wpn_fps_shak12_upg_ap_kit_desc = "Allows you to penetrate shields, walls, enemy body armor and multiple enemies.\nLimits your fire mode to single fire.\nAmmo pick up reduced by 40%.",
					...
					bm_wpn_fps_lmg_hcar_barrel_dmr_PEN_desc = "Allows you to penetrate shiels, body armor, walls and multiple enemies.\nLimits weapon to single-fire mode.\nAmmo pick up reduced by 40%.",
					...
					bm_wpn_fps_upg_a_underbarrel_launcher_electric_desc = "Upon impact creates a wider 8m electrical explosion, with 800 max damage. Enemies caught in the blast radius get stunned due to high-voltage electricity for 3-5 seconds.\nDamage scales with range more aggressively, which leads to enemies on the edge of the explosion radius to receiving minimal damage.\n\nAmmo pick up for the underbarrel launcher increased by 20%.",
					bm_wpn_fps_upg_a_grenade_launcher_hornet_desc = "Fires 20 shotgun-like rounds upon detonation that can pierce shields, enemies and their body armor. Minimal shotgun damage multiplier: 1.\n\nAmmo pick up increased by 250%.",
					bm_wpn_fps_upg_a_grenade_launcher_hornet_underbarrel_desc = "Fires 20 shotgun-like rounds that can pierce through enemies, enemy body armor and shields. Max damage: 450. Minimal shotgun damage multiplier: 1.\n\nAmmo pick up for the underbarrel launcher is set to roughly 0.825.",
					...
					-- Flare gun mods
					bm_wp_upg_a_flun_shell_desc = "Standard shotgun ammo.\n\nAmmo pickup increased to compensate lack of explosive firepower.",
				})
			end
			...
			local function Custom_Gilza_attachs()
				LocalizationManager:add_localized_strings({
					...
					bm_wpn_fps_upg_pis_mid_ap_rounds_lv_desc = "Allows you to penetrate shiels, body armor, walls and multiple enemies.\nAmmo pick up reduced to compensate both new damage class and gained AP.",
					...
					wpn_fps_upg_shak12_250_dmg_kit = "12.7x55mm PS12A",
					wpn_fps_upg_shak12_250_dmg_kit_desc = "A special cartridge with a 7 gram lightweight bullet with an aluminum core and two-layer semi-jacket, a lead interior, and a bimetallic exterior, in a brass case.\n\nAmmo pick up increased to match new damage class.",
					bm_wpn_fps_upg_type54_underbarrel_ammo_pickup_adjuster = "Default pistol ammo without the 30% underbarrel pickup penalty.", -- lmao
					bm_wpn_fps_upg_250_smg_ap_kit = "9x19mm PBP gzh",
					bm_wpn_fps_upg_155_smg_ap_kit = "9x19mm AP 6.3",
					bm_wpn_fps_upg_100_smg_ap_kit = "9x19mm Pst gzh",
					-- GL section
			...
			local function Weapon_descs()
				LocalizationManager:add_localized_strings({
					...
					bm_w_g36_desc = "Can be used in a 2 round burst fire mode.",
					bm_w_komodo_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_g3_desc = "Can be used in a 2 round burst fire mode.",
					bm_w_s552_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_m4_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_groza_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_asval_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_aug_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_scar_desc = "Can be used in a 2 round burst fire mode.",
					bm_w_beer_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_x_beer_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_hajk_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_x_hajk_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_vityaz_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_x_vityaz_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_mp5_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_x_mp5_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_scorpion_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_x_scorpion_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_mp9_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_x_mp9_desc = "Can be used in a 3 round burst fire mode.",
					bm_w_shepheard_desc = "Can be used in a 3 round burst fire mode.",
			...
			local function Supported_custom_weapons_strings()
				LocalizationManager:add_localized_strings({
					...
					bm_w_crysis3_typhoon_desc = "Fires off 5 bullets per trigger pull, each dealing 14 damage.",
					bm_w_hx25_desc = "Fires off 5 explosive rounds each dealing 150 damage.",
					bm_w_blast_desc = "Fires off 3 nanites each dealing 51 damage.",
					bm_w_g3hk79_desc = "Can be used in a 2 round burst fire mode.",
					bm_w_kurisumasu_desc = "Can be used in a 3 round burst fire mode.",
				})
			end
			...
			local function Custom_attachs_non_Gilza()
				LocalizationManager:add_localized_strings({
					...
					bm_wp_wpn_fps_upg_hx25_buckshot_ammo_desc = "Fires 10 shotgun rounds, and allows for shotgun skills to work with this weapon.\nMinimal shotgun damage multiplier: 0.8.\n\nAmmo pick up increased.",
					-- Railgun Rorsch MK-1
					bm_wp_wpn_fps_special_roach_a_sabot_desc = "2-Stage Sabot Projectile, like a miniaturized discarding-sabot round that modern tank use.\nTravelling at 3.6 km/sec, the amount of energy it stored will create a small explosion at point of impact.\nAmmo pickup and bonus headshot damage disabled.",
					bm_wp_wpn_fps_special_roach_a_thermal_desc = "Using early Mass-Effect theory, the railgun can abandon the need for conventional projectile, and instead used a block of heavy metal to \"generate\" projectiles the size of sand.\nFires 8 projectiles each dealing 1500 explosive damage.\nAmmo pickup and bonus headshot damage disabled.",
					bm_wp_wpn_fps_special_roach_a_tungsten_desc = "Conventional Tungsten-core Projectile, like what small-arms used.\nTravelling at much lower velocity than the Sabot, it still boast destructive penetrating power, but doesn't produce explosion on impact.\nAmmo pickup enabled.",
					-- SIG Sauer MCX SPEAR/XM7 NGSW-R
					bm_wp_wpn_fps_ass_mcx_spear_am_default_desc = "NGSW comissioned caliber that pierces body armor, shields, walls, and enemies.\nAmmo pickup reduced by 40%.",
					bm_wp_wpn_fps_ass_mcx_spear_am_762_desc = "Reduces damage class and updates ammo pickup accordingly. Does not grant any type of piercing.",
					bm_wp_wpn_fps_ass_mcx_spear_am_creedmoor_desc = "Does not grant any type of piercing. Ammo pickup is equal to default ammo pick up of this damage class.\n\nFor people who prefer the battle rifle archetype (comparable to the vanilla G3), but hate the recoil penalties associated with the NGSW caliber.",
					bm_wp_wpn_fps_ass_mcx_spear_barrel_marksman_desc = "A reference to the weapon's original conception as an entrant in the US Military's CSASS contract.",
					-- Defiance Blast Rifle
					bm_wp_wpn_fps_upg_blast_ammo_syphon_desc = "Fires a single round with vampiric-like nanites that drain the life out of the target it makes contact with, enabling the user to replenish as a result.\n\nHitting an alive enemy regenerates 15% of dealt damage as both armor and health, once every 1.5 seconds.\nHitting any other object deals 3% of dealt damage to your health and armor.\nAmmo pick up reduced by 35%.",
					bm_wp_wpn_fps_upg_blast_ammo_ap_desc = "Extremely dense and extremely unstable nanites capable of punching directly through armor, enemies, walls, shields and possibly giving them cancer 10 years from now.\n\nAmmo pick up reduced by 40%.",
					bm_wp_wpn_fps_upg_blast_ammo_fire_desc = "High-flammability nanites that have a 33% chance to ignite on impact with armor and tissue, setting a target ablaze for additional 100 damage over 2 seconds. Capable of penetrating body armor and shields.\n\nAmmo pick up reduced by 40%.",
					bm_wp_wpn_fps_upg_blast_ammo_poison_desc = "Biohazardous nanites that corrode through enemies and armor, and fill a target with toxic materials for additional 160 damage over 2 seconds, preventing enemies from making offensive actions during the period.\n\nAmmo pick up reduced by 20%.",
					bm_wp_wpn_fps_upg_blast_ammo_stun_desc = "Charge-carrying nanites that form a circuit on impact with a target, delivering an intense electrical shock capable of stunning and crippling most enemies, in addition to cooking them alive.\n\nDisables bonus headshot damage.\nAmmo pick up increased by 20%.",
				})
			end
		...
		local function UI_strings()
			LocalizationManager:add_localized_strings({
				...
				Gilza_AFSF_warning_str = "\"Auto Fire Sound Fix\" mod detected, and automatically disabled. Please uninstall it to avoid issues while running Gilza.",
				Gilza_BTAW_warning_str = "\"Bipods that work\" mod detected - please uninstall it to avoid issues while running Gilza.",
				Gilza_LMG_STEELSIGHTS_warning_str = "\"LMG Steelsights\" mod detected - please uninstall it to avoid issues while running Gilza.",
				-- armor based ammo pick up description
				bm_menu_armor_pickup_desc = "Ammo and throwables pick up rate: $amount;",
				...
				Gilza_new_skill_zerk_weapons = "Weapons",
				Gilza_new_skill_zerk_melee = "Melee",
				Gilza_new_skill_stockholm_basic = "Menace",
				Gilza_new_skill_body_economy = "Reload",
				Gilza_new_skill_unseen_strike_eligibility = "Eligible",
				Gilza_new_skill_unseen_strike_crits = "Crits",
				Gilza_new_skill_offhand_reload_duration = "Offhand",
				wolfhud_hudlist_dire_need_buff_desc = "This option is configurable by Gilza, and is now part of \"Backfire\" basic skill. Please go to Gilza's mod options to adjust it.",
				wolfhud_hudlist_lock_n_load_buff_desc = "This option is now only configurable by Gilza. Please go to Gilza's mod options to adjust this option.",
				wolfhud_hudlist_unseen_strike_buff_desc = "This option is now only configurable by Gilza. Please go to Gilza's mod options to adjust this option.",
				wolfhud_hudlist_buff_dmg_dec = "DR",
				Gilza_new_vhud_dmg_aborb_total = "DA",
				wolfhud_hudlist_buff_tot_dodge = "Dodge",
				Gilza_new_hitman_recovery_bonus_tag = "Recovery",
			})
		end
		UI_strings()
		
		-- strings that have either incorrect/inaccurate/not complete information, or use different-from-the-rest terminology
		-- they are also vanilla in functionality. if functionality of a skill is updated by Gilza, strings for that are higher up in this func
		local function Additional_fix_strings()
			LocalizationManager:add_localized_strings({
				-- skills
				menu_tea_time_beta_desc = "BASIC: ##$basic;##\nDecreases your First Aid Kit and Doctor Bag deploy time by ##50%##.\n\nACE: ##$pro;##\nYour First Aid Kits and Doctor Bags now provide a ##10%## damage resistance bonus for ##120## seconds to the player who used it.",
				menu_fast_learner_beta_desc = "BASIC: ##$basic;##\nCrew members you revive gain ##30%## damage resistance for ##5## seconds.\n\nACE: ##$pro;##\nThe damage resistance is increased by an additional ##50%##.",
				...
				menu_deck12_3_short = "The lower your health, the more movement speed you gain. This effect is active only while your health is bellow ##25%##. Maximum movement speed bonus you can get is ##20%##.",
				menu_deck12_5_desc = "Maximum armor recovery bonus while at low health is increased by an additional ##20%##.",
	...
	local function AddRussianLoc()
		...
		local function Perk_strings_vanilla()
			...
			local function Neutral_cards()
				LocalizationManager:add_localized_strings({
					...
					menu_deckall_6_desc = "Открывает сумку с броней, содержимое которой можно надеть во время ограбления.\n\nВы получаете возможность найти метательное оружие в оставленных врагами боеприпасах. Счетчик начинается с ##0## и поднимается на ##+1## за каждый подобранный боеприпас. После достижения необходимого количества найденных боеприпасов вы получите ##1## метательное оружие, после чего счетчик сбросится до ##0##. Каждое метательное оружие имеет уникальное необоходимое количество подобранных боеприпасов - конкретные значения можно узнать в их описании.",
			...
			local function Crew_chief_str()
				LocalizationManager:add_localized_strings({
					...
					-- short descs
					menu_deck1_3_short = "Выносливость всех членов команды, увеличена на ##50%##. Дальность вашего крика увеличена на ##25%##. Пока вы находитесь близко к врагу, вы получаете меньше урона.",
			...
			local function Rogue_str()
				LocalizationManager:add_localized_strings({
					menu_deck4_9_desc = "Шанс увернуться когда вы пригнулись увеличен на ##5%##.\n\nШанс пробить вражескую нательную броню из любого оружия увеличен на ##40%##.\nВремя переключения между оружием уменьшено на ##33%##.\n\nВаша скорость передвижения увеличена на ##10%## и запас выносливости увеличен на ##25%##.\n\nБонус завершения ряда: Вероятность получить предмет высокого качества после завершения контракта увеличина на ##10%##.",
					-- short descs
					menu_deck4_9_short = "Шанс увернуться когда вы пригнулись увеличен на ##5%##. Шанс пробить вражескую нательную броню из любого оружия увеличен на ##40%##. Время переключения между оружием уменьшено на ##33%##. Ваша скорость передвижения увеличена на ##10%## и запас выносливости увеличен на ##25%##.",
				})
			end
			Rogue_str()
			...
			local function Hitman_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck5_1_desc = "Убийство врага оружием ближнего боя, или не-взрывчатым метательным оружием восполнит ##20%## вашей брони.\n\nВы получаете ##5%## к прочности вашей брони.",
					...
					-- short descs
					menu_deck5_1_short = "Убийство врага оружием ближнего боя или не-взрывчатым метательным оружием восполняет ##20%## брони.",
					...
					menu_deck5_5_short = "Новая способность: В ритме смерти. ##4## убийства в идеальном комбо дают ##8-12## секунд неуязвимости, с кулдауном в ##30## секунд. Первое убийство должно быть совершено оружием ближнего боя или не-взрывчатым метательным оружием.",
			...
			local function Sociopath_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck9_7_desc = "Если при убийстве врага он был в пределах ##18## метров от вас, вы восполните еще ##30## брони.\n\nПрочность брони увеличена на еще ##10%##.",
			...
			local function Ex_president_str()
				LocalizationManager:add_localized_strings({
					menu_deck13_1_desc = "Пока ваша броня не сломлена вы будете получать ##4## единицы запасного здоровья за каждого убитого вами, или вашей командой, противника.\nМаксимальное количество запасного здоровья зависит от используемой вами брони, и доступно вам для просмотра в описанях брони.\n\nПосле того как ваша броня опустится до 0, при последующем восстановлении брони активируется восстановление вашего основного здоровья за счет запасного здоровья.\nЗапасное здоровье будет исчерпано для восстановления как можно большего количества основного здоровья. Если после у вас останется запасное здорове - оно будет уменьшено на ##48## очков.",
					...
					menu_deck13_5_desc = "Максимальное количество запасного здоровья увеличено на ##50%##.\n\nВаше основное здоровье увеличено на ##10%##.\n\nВы получаете статичный шанс увернуться в ##20%##. Статичный шанс уворота нельзя увеличить или уменьшить используя навыки влияющие на уворот или заменяя используемую броню.",
					menu_deck13_7_desc = "Количество запасного здоровья получаемого за убийство противников увеличено на еще ##4##.\n\nВаше основное здоровье увеличено на еще ##20%##.\n\nПри получении урона по основному здоровью, получаемый урон будет сначала нанесен по вашему запасному здоровью, убавляя его количество.\nЕсли получаемый урон выше чем количество вашего запасного здоровья, урон будет уменьшен вашим запасным здоровьем, и затем нанесен по вашему основному здоровью.",
					menu_deck13_9_desc = "За каждого убитого вами или вашей командой противника ваш таймер восставновления брони будет уменьшен на долю секунды. Объем ускорения зависит от используемой брони - чем сильнее броня, тем меньше ускорение таймера. Данный бонус не может сократить таймер регенерации брони до значения меньше чем ##0.8## секунд.\nДанный бонус обнуляется если запасное здоровье было потрачено либо для восполнения основного здоровья, либо для защиты основного здоровья от входящего урона.\n\nПометки:\n- Навыки влияющие на скорость восстановления брони добавляют свои бонусы после высчитывания таймера данным навыком перка.\n- Данный навык не влияет на эффект подавления.\n\nПометка: иконка перков мода Gilza покажет скорость регенерации вашей брони, учитывая только бонус данного навыка перка.\n\nБонус завершения ряда: Вероятность получить предмет высокого качества после завершения контракта увеличена на ##10%##.",
					-- armor description for blackmarket UI
					...
					menu_deck13_7_short = "Количество запасного здоровья, получаемого за убийство увеличено. Ваше здоровье увеличено. Запасное здорове теперь может защищать основное здоровье.",
					menu_deck13_9_short = "За каждого убитого вами или вашей командой противника вы будете уменьшать ваш таймер восставновления брони на долю секунды, до того как вы потратите запасное здоровье.",
				})
			end
			Ex_president_str()
			...
			local function Sicario_str()
				LocalizationManager:add_localized_strings({
					menu_deck18_1_desc = "Разблокирует и позволяет взять с собой дымовую шашку. Если вы смените набор перков на другой, дымовая шашка будет недоступна для использования.\n\nПри использовании, с помощи кнопки ##$BTN_ABILITY;##, дымовая шашка создаёт завесу, которая длится ##10## секунд. Пока вы и ваши напарники стоят в завесе, вы будете уворачиваться от ##50%## всех пуль. Любой враг, находящийся в дыму, будет менее точен при стрельбе на ##50%##.\n\nВы не можете использовать дымовую шашку чаще чем раз в ##60## секунд, но убийство врагов сокращает время восстановления на ##1## секунду.",
					menu_deck18_3_desc = "При получении урона от пуль или в ближнем бою, вы получаете прибавку к вашему шансу увернуться в размере ##15%##.\n\nПосле удачного уворота бонус к увороту сбросится, и вы не сможете получать данный бонус в течении нескольких секунд.\n\nКулдаун зависит от используемой брони, и его можно узнать в описаниях брони.",
					menu_deck18_9_desc = "Пока вы стоите в вашей дымовой завесе, бонусный уворот от карточки перка \"Момент удачи\" будет удвоен, и этот бонус не будет сбрасываться при удачном увороте. Бонусный уворот от карточки перка \"Неуловимый\" будет также удвоен.\n\nВаши напарники получают ##10%## уворота пока они находятся внутри вашей дымовой завесы.\n\nБонус завершения ряда: Вероятность получить предмет высокого качества после завершения контракта увеличена на ##10%##.",
					bm_menu_sicario_armor_CD_desc = "Набор перков Sicario:\nКулдаун карточки перка \"Момент удачи\": $amount_1 секунд.",
					-- short descs
					menu_deck18_1_short = "Разблокирует и позволяет взять с собой дымовую шашку. При использовании, дымовая шашка создаёт завесу, которая длится ##10## секунд. Вы и ваши напарники стоя в завесе,  уворачиваетесь от ##50%## всех пуль. Любой враг, находящийся в дыму, будет менее точен при стрельбе на ##50%##. Вы не можете использовать дымовую шашку чаще чем раз в ##60## секунд, но убийство врагов сокращает время восстановления на ##1## секунду.",
					menu_deck18_3_short = "При получении урона от пуль или в ближнем бою, вы получаете прибавку к вашему шансу увернуться в размере ##15%##. После удачного уворота бонус к увороту сбросится, и вы не сможете получать данный бонус в течении нескольких секунд.",
				})
			end
			Sicario_str()
			...
			local function Hacker_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck21_7_desc = "При убийстве как минимум ##3## противников во время Звуковой петли вы получаете ##15%## бонус к шансу уклонения на ##50## секунд.",
					-- short descs
					...
					menu_deck21_7_short = "При убийстве как минимум ##3## противников во время Звуковой петли вы получаете ##15%## бонус к шансу уклонения на ##50## секунд.",
				})
			end
			Hacker_str()
			...
			local function Leech_str()
				LocalizationManager:add_localized_strings({
					menu_deck22_1_desc = "Открывает и экипирует Ампулу Кровопийцы в слот метательного оружия. После активации клавишей ##$BTN_ABILITY;##, ампула будет длиться ##6## секунд, с кулдауном ##60## секунд. Если вы упадете когда Ампула готова к использованию, или ее кулдаун меньше ##20## секунд, таймер кулдауна будет увеличен до ##20## секунд.\n\nАктивация Ампулы восполняет ##50%## здоровья, временно отключает броню, и делит ваше здоровье на ##25%## сегменты. Получение урона отнимает один сегмент, но если полученный урон выше 150 урона, вы потеряете два сегмента.\nПри потере сегмента(-ов) вы переходите в предохранительное состояние на ##1## секунду, получая неуязвимость к урону. Убийство в период предохранительного состояния восполнит один потерянный сегмент здоровья, но не чаще чем один раз за один предохранительный период. При восстановлении сегмента таким образом, ваши союзники восполнят ##5%## своего здоровья. Каждый дополнительный игрок с набором перков Кровопийца уменьшает данное командное восполнение здоровья на ##25%##. Если вы поднимите союзника под действием Ампулы, вы восполните ##50%## вашего здоровья и ##100%## вашей брони после окончания эффекта Ампулы.",
					menu_deck22_3_desc = "Ваше здоровье увеличено на ##20%##.\n\nВо время действия Ампулы Кровопийцы вы не можете упасть, но если ваше здоровье упадет до ##0## вы перейдёте в режим Последнего Дыхания, снижающий скорость передвижения на ##80%##, отключающий возможность лечения от навыков, отключающий предотвращение падений от навыка \"Колеса\", и отключающий возможность лечиться с помощью аптечек первой помощи и медицинских сумок. Единственный способ восполнения здоровья режиме Последнего Дыхания это убийство врага пока вы находитесь в предохранительном состоянии.\nЕсли эффект Ампулы закончится во время режима Последнего Дыхания, вы автоматически упадёте, если только вы не подняли союзника за время действия Ампулы.",
					menu_deck22_5_desc = "Длительность эффекта Ампулы Кровопийцы увеличена до ##10## секунд.\n\nУбийство противника сокращает кулдаун Ампулы на ##1## секунду.\n\nВосполнение сегмента здоровья во время предохранительного периода теперь восполняет ##10%## здоровья вашим союзникам.\n\nПри поднятии союзника вы восполните ему ##20%## здоровья а себе - ##10%## здоровья.\nПометка: союзники могут получить лечение вплоть до 4 секунд после воскрешения в зависимости от их пинга.",
					menu_deck22_7_desc = "Ваше здоровье увеличено на ##60%##.\n\nКулдаун Ампулы будет сокращен на ##10## секунд каждый раз когда:\n- Вы поднимите союзника\n- Вас поднимет союзник, или вы подниметесь сами по себе\n- Эффект Ампулы закончится, если вы подняли союзника во время действия эффекта Ампулы",
					menu_deck22_9_desc = "Теперь вы можете активировать Ампулу Кровопийцы после падения, что временно поднимет вас на ноги до истечения эффекта Ампулы. Это действие накладывает дополнительные ##40## секунд кулдауна на Ампулу Кровопийцы.\nПометка: Если вы подняли сами себя на ноги, используя Ампулу, навык, сокращающий кулдаун Ампулы из карточки перка \"Не как все\", не активируется.\n\nПосле того как вы подняли себя с помощью Ампулы Кровопийцы, вы можете остаться в живых после окончания эффекта Ампулы, если либо успешно используете медицинскую сумку и ваше здоровье будет выше ##0##, либо успешно поднимете союзника.\n\nПока Ампула Кровопийцы активна, ваше здоровье разбивается на сегменты, равные ##20%## вашего здоровья. Убийства во время предохранительного периода теперь восполняют ##2## сегмента здоровья вместо ##1##, а ваши союзники будут восполнять ##20%## своего здоровья вместо ##10%##.\n\nБонус завершения ряда: Вероятность получить предмет высокого качества после завершения контракта увеличена на ##10%##.",
					-- short descs
					menu_deck22_1_short = "Открывает и экипирует Ампулу Кровопийцы, позваляющую вам поддерживать своих союзников и себя дополнительным здоровьем.",
					...
					menu_deck22_7_short = "Ваше здоровье увеличено, и кулдаун Ампулы теперь ускоряется когда вы поднимаете союзников, или когда вы поднимаетесь.",
			...
			local function Copycat_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck23_1_4_desc = "Ваша скорость передвижения в присяди и во время переноса сумок ускорена на ##10%##. Количество боезапаса которое вы можете взять с собой увеличено на ##5%##.",
					menu_deck23_3_4_desc = "Ваша скорость передвижения в присяди и во время переноса сумок ускорена на ##10%##. Количество боезапаса которое вы можете взять с собой увеличено на ##5%##.",
					menu_deck23_5_4_desc = "Ваша скорость передвижения в присяди и во время переноса сумок ускорена на ##10%##. Количество боезапаса которое вы можете взять с собой увеличено на ##5%##.",
					menu_deck23_7_4_desc = "Ваша скорость передвижения в присяди и во время переноса сумок ускорена на ##10%##. Количество боезапаса которое вы можете взять с собой увеличено на ##5%##.",
					-- 9th card bonuses
					...
					menu_deck23_9_biker_desc = "Каждое убийство, совершенное вами или вашей командой, может добавить вам 1 Стак Регенерации. Полученный Стак мгновенно восполняет ##4## здоровья и ##4## брони, после чего активирует свой кулдаун в ##6## секунд, по истечении которого Стак исчезает.\n\nМаксимальное количество слотов для Стаков Регенерации - ##4##. Новые Стаки не могут быть получены, если все слоты заняты, или если вы одновременно имеете максимальный уровень здоровья и брони.\n\nЕсли ваш уровень брони не равен нулю, при получении Стака Регенерации активируется эффект Предотвращения Переполнения Стаков длительностью в ##1## секунду.\nВо время действия этого эффекта новые Стаки Регенерации не могут быть получены, если уровень вашей брони выше нуля.",
					menu_deck23_9_stoic_desc = "Разблокирует и позволяет взять с собой флягу.\n\nЕсли вы смените набор перков на другой, фляга будет недоступна для использования. Фляга использует слот для метательного оружия, но вы можете взять вместо неё что-нибудь другое.\n\nЧтобы отпить из фляги, достаточно нажать на кнопку для метательного оружия ##$BTN_ABILITY;##.\n\nВесь получаемый урон разделен. ##50%## урона будут нанесёны сразу, а оставшиеся ##50%## будут наноситься по вам периодически в течении ##10## секунд.\n\nОтпив из фляги, весь периодический урон исчезает. Фляга имеет ##10## секундный кулдаун, но каждое совершенное убийство будет сокращать кулдаун на ##1## секунду.",
					menu_deck23_9_leech_desc = "Открывает и экипирует Ампулу Кровопийцы активируемую клавишей ##$BTN_ABILITY;##. Ампула длится ##6## секунд, с кулдауном ##60## секунд. Если вы упадете при кулдауне Ампулы меньше ##20## секунд, таймер кулдауна будет увеличен до ##20## секунд. Активация Ампулы восполняет ##50%## здоровья, временно отключает броню, и делит ваше здоровье на ##25%## сегменты. Получение урона отнимает один сегмент, но если полученный урон выше 150 урона, вы потеряете два сегмента. При потере сегмента(-ов) вы переходите в предохранительное состояние на ##1## секунду, получая неуязвимость к урону. Убийство в период предохранительного состояния восполнит один потерянный сегмент здоровья, но не чаще чем один раз за один предохранительный период. При восстановлении сегмента таким образом, ваши союзники восполнят ##5%## своего здоровья. Каждый дополнительный игрок с Ампулой уменьшает командное восполнение здоровья на ##25%##. Если вы поднимите союзника под действием Ампулы, вы восполните ##50%## здоровья, ##100%## брони и ##10## секунд кулдауна Ампулы после окончания ее эффекта. Кулдаун Ампулы будет сокращен на ##10## секунд если вы поднимите союзника, если вы были подняты союзником, или вы поднялись сами по себе.",
					menu_deck23_9_brawler_desc = "Вы теперь можете получить вплоть до ##3## стаков регенерации брони от данной карточки перка. Если у вас нет ни одного стака вы можете получить первый стак убив врага любым способом. Чтобы получить больше стаков вам нужно убивать врагов используя оружие ближнего боя или пилу OVE9000.\nОдин стак регенерации брони восполняет ##20## очков брони в течении ##10## секунд, с интервалами частичной регенерации раз в ##2.5## секунды.\nИграя на сложности Смертельный Приговор вы будете восполнять ##50## очков брони за такой же срок.\n\nПометка: иконка перков мода Gilza покажет количество эффектов регенерации которое вы имеете в виде текста \"1x\" под иконкой.",
					menu_deck23_9_junkie = "Под спидами",
					menu_deck23_9_junkie_desc = "Вы можете иметь вплоть до ##100## стаков адреналина. Быстрое передвижение добавляет адреналин - чем быстрее вы двигаетесь, тем больше стаков вы получаете. Если вы двигаетесь недостаточно быстро ваш адреналин будет уменьшаться.\n\nЗа каждый стак адреналина вы получаете шанс увернуться, вплоть до максимального шанса в ##45%## при ##100## стаках.\n\nЕсли вы будете поддерживать ##90## и более адреналина дольше чем ##3## секунды вы обессилете. Обессилее полностью исчерпывает вашу выносливость и некоторую часть ваших стаков адреналина.\n\nВаша броня теперь может восстанавливаться только когда вы полностью неподвижны.\n\nПометка: иконка перков мода Gilza покажет количество стаков адреналина, если ваш уровень адреналина слишком высок (красный) и если вы обессилите (фиолетовый).",
		...
		local function Perk_strings_custom()
			...
			local function Brawler_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck_brawler1_desc = "Время восстановления брони замедлено на ##350%##.\nВаш боезапас уменьшен на ##80%##. Заметьте что данное снижение накладывается после всех других навыков связанных с боезапасом как множитель ##0.2##, что не повзолит вам компенсировать данный эффект другими навыками.\n\nВы больше не можете подбирать патроны оставленные врагами, но вместо этого, при получении достачного количества попаданий от пуль или в ближнем бою, вы получите эквивалент ##1## пачки патронов которые обычно оставляют враги, содержащую в себе стяжки (случайно), метательное оружие (в стандартном объеме) и патроны для оружия (в уменьшеном на ##80%## объеме; действует как множитель ##0.2##, что не повзолит вам компенсировать это уменьшение другими навыками).\nПри использовании арбалета/лука подбирая обратно болт/стрелу вы имеете только ##20%## шанс получить ее обратно в боезапас.\n\nВы теперь можете наносить бонусный урон при попадании в голову используя оружия ближнего боя.\nВаша броня получает сопротивление к пулевому урону в размере ##5%## пока вы используете оружие ближнего боя.",
					menu_deck_brawler3 = "Улучшения маневренности",
					menu_deck_brawler3_desc = "Ваша броня получает дополнительное сопротивление к пулевому урону в размере ##5%##, пока вы используете оружие ближнего боя.\n\nШтраф к скорости передвижения в броне уменьшен на еще ##25%##.",
					menu_deck_brawler5 = "Улучшение бронепластины",
					menu_deck_brawler5_desc = "Вашу броню теперь невозможно пробить насквозь бронебойными выстрелами.\n\nВаша броня получает дополнительное сопротивление к пулевому урону в размере ##10%##, пока вы используете оружие ближнего боя.\n\nШтраф к скорости передвижения в броне уменьшен на еще ##25%##.\n\nУбийство противника в рукопашном бою восстанавливает ##5%## вашей выносливости.",
					menu_deck_brawler7 = "Мясной щит",
					menu_deck_brawler7_desc = "Когда ваше здоровье ниже ##50%##, ваша броня получает по ##4%## сопротивления пулевому урону за каждого союзника в радиусе ##21м## вокруг вас. Данный бонус не складывается больше ##3## раз.\nВраги которых лично вы перевели на свою сторону будут считаться как союзники для данной карточки перка.\nПри игре на сложности Смертный Приговор бонус сопротивления урону данной карточки перка увеличивается до ##8%##.\n\nВероятность того что по вам начнут стрелять когда вы находитесь рядом с союзниками выше на ##15%##. Все остальные навыки уменьшающие эту вероятность отныне игнорируются.\n\nПометка: иконка перков мода Gilza покажет количество союзников в радиусе: 0 - тусклый белый цвет, 1 - белый цвет, 2 - желтый цвет, 3 - зеленый цвет.",
					menu_deck_brawler9 = "Кровожадный кевлар",
					menu_deck_brawler9_desc = "Убийство врага в ближнем бою мгновенно восполнит ##40## единиц брони. Играя на сложности Смертельный Приговор вы будете восполнять ##120## единиц брони за убийство.\n\nВы теперь можете получить вплоть до ##3## стаков регенерации брони от данной карточки перка. Если у вас нет ни одного стака вы можете получить первый стак убив врага любым способом. Чтобы получить больше стаков вам нужно убивать врагов используя оружие ближнего боя или пилу OVE9000.\nОдин стак регенерации брони восполняет ##40## очков брони в течении ##10## секунд, с интервалами частичной регенерации раз в ##2## секунды.\nИграя на сложности Смертельный Приговор вы будете восполнять ##120## очков брони за такой же срок.\n\nБонус завершения ряда: Вероятность получить предмет высокого качества после завершения контракта увеличина на ##10%##.\n\nПометка: иконка перков мода Gilza покажет количество эффектов регенерации которое вы имеете в виде текста \"1x\" под иконкой.",
					-- short descs
					menu_deck_brawler1_desc_short = "Ваш запас и подбираемое количество боеприпасов уменьшены. Ваши удары в ближнем бою, наносят больше урона при попадании в голову. Ваша броня получает сопротивление к пулевому урону.",
					...
					menu_deck_brawler9_desc_short = "Убийства в ближнем бою восполняют броню.",
				})
			end
			Brawler_str()
			...
			local function Speed_Junkie_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck_SJ_1_desc = "Вы можете иметь вплоть до ##100## стаков адреналина. Быстрое передвижение добавляет адреналин - чем быстрее вы двигаетесь, тем больше стаков вы получаете. Если вы двигаетесь недостаточно быстро ваш адреналин будет уменьшаться. Уменьшение адреналина приостанавливается при взаимодействии с предметами.\n\nЗа каждый стак адреналина вы получаете шанс увернуться, вплоть до максимального шанса в ##45%## при ##100## стаках.\n\nЕсли вы будете поддерживать ##90## и более адреналина дольше чем ##3## секунды вы обессилете. Обессилее полностью исчерпывает вашу выносливость и некоторую часть ваших стаков адреналина.\n\nВаша броня теперь может восстанавливаться только когда вы полностью неподвижны.\n\nВы преобразуете ##90%## вашего здоровья в ##42%## брони.\n\nПометка: иконка перков мода Gilza покажет количество стаков адреналина, если ваш уровень адреналина слишком высок (красный) и если вы обессилите (фиолетовый).",
					menu_deck_SJ_3 = "Непереубеждаем",
					menu_deck_SJ_3_desc = "Шанс увернуться увеличен на ##15%##.\n\nВы восстанавливаете ##5%## вашей выносливости за каждое убийство.\n\nВы теперь преобразуете ##90%## вашего здоровья в ##46%## брони.",
					menu_deck_SJ_5 = "Стимуляция",
					menu_deck_SJ_5_desc = "Убийсто врага добавит вам ##5-20## стаков адреналина - чем меньше у вас адреналина тем больше вы его получите.\nЕсли вы убьете врага когда количество стаков адреналина превышает ##90##, ваш адреналин будет автоматически уменьшен до ##90##.\n\nДополнительный эффект: вспышка адреналина.\nКогда количество стаков адреналина выше ##70## вы будуте получать ##1## очко вспышки адреналина в секунду. При накоплении ##40## очков вспышки адреналина вы получаете право ее активировать. Если вы имеете право ее активировать, убийство врага имеет ##10%## шанс активировать вспышку адреналина. При активации вспышки, ваши стаки адреналина получают передоз на ##12## секунд. После окончания вспышки адреналина, вы обессилете, а количество очко вспышки опустится до ##0##.\n\nВы теперь преобразуете ##90%## вашего здоровья в ##52%## брони.",
					menu_deck_SJ_7 = "Только один конец",
					menu_deck_SJ_7_desc = "При удачном увороте вы получите ##15## единиц брони, однако если ваша броня полностью сломана, вы получите ##45## единиц брони. Данный эффект не может срабатывать чаще чем раз в ##1## секунду.",
					...
					-- short descs
					menu_deck_SJ_1_desc_short = "Открывает стаки адреналина, добавляющие вплоть до ##45%## шанса увернуться. Восстановление брони теперь недоступно в движении. Преобразует здоровье в броню.",
					...
					menu_deck_SJ_5_desc_short = "Убийсива добавляют стаки адреналина. Преобразует здоровье в больше брони. Новый эффект: вспышка адреналина.",
			...
			local function Guardian_str()
				LocalizationManager:add_localized_strings({
					...
					menu_deck_Gilza_guardian_7_desc_short = "Вы можете автоматически наносить ответный урон.",
		...
		local function Skill_strings()
			...
			local function Mastermind_str()
				LocalizationManager:add_localized_strings({
					...
					menu_inspire_beta_desc = "БАЗОВЫЙ: ##$basic##\nВы поднимаете напарников быстрее на ##100%##.\n\nЕсли вы крикните на вашего напарника, вы и ваш напарник получите моральный буст на ##10## секунд. Данный буст увеличивает скорость передвижения и перезарядки на ##20%## для вашего напарника и на ##10%## для вас.\n\nПРО: ##$pro##\nВы можете поднять напарника с вероятностью ##100%##, если вы крикните на него. Ваш крик от данного навыка имеет ##9## метровый радиус и не может быть использован чаще чем раз в ##20## секунд.",
					-- M2
					...
					menu_stockholm_syndrome_beta_desc = "БАЗОВЫЙ: ##$basic;##\nУбийство гражданского дает вам ##1.5## очко(в) запугивания. Убийство взятого в заложники врага дает вам ##0.5## очко(в) запугивания. Вы не можете иметь больше ##4## очков запугивания. При попадании в тюрьму ваши очки запугивания збрасываются до ##0##.\n\nПри убийстве противника у вас есть ##10%## шанс посеять панику в ##10## метровом радиусе вокруг вас. Паника будет подавлять противника, периодически заставляя его испытывать приступы неконтролируемого страха.\nЗа каждое ##1## очко запугивания вы увеличиваете свой шанс посеять панику на ##10%##, и увеличиваете количество создаваемой паники.\nКоличество создаваемой паники влияет на шансы врагов оставаться в паническом состоянии дольше.\n\nПРО: ##$pro;##\nВаши заложники не станут убегать, если они были освобождены полицией. Как только вы попадёте в тюрьму, они попытаются обменять себя на вас. Этот эффект может сработать даже во время полицейского штурма, но только ##1## раз за день ограбления.",
					-- M3
					...
					menu_speedy_reload_beta_desc = "БАЗОВЫЙ: ##$basic##\nПовышает скорость перезарядки штурмовых винтовок, пистолетов-пулемётов и снайперских винтовок на ##20%##.\n\nИспользуя штурмовую винтовку, пистолет-пулемёт или снайперскую винтовку в одиночном режиме стрельбы, убийство противника в тело будет восполнять боезапас ваших оружий в количестве ##10%## от одной пачки боеприпасов оставленной врагом.\n\nПРО: ##$pro##\nУбийство врагов в одиночном режиме стрельбы теперь восполняет ##40%## от одной пачки боеприпасов.\n\nИспользуя штурмовую винтовку, пистолет-пулемёт или снайперскую винтовку в одиночном режиме стрельбы, вы получаете ##7.5%## бонус к скорости перезарядки любого оружия за убийство противника в тело, вплоть до ##75%##. Убийство после удачной перезарядки сбросит данный бонус до ##0##.",
					menu_sniper_graze_damage_desc = "БАЗОВЫЙ: ##$basic;##\nВыстрелы в одиночном режиме стрельбы из снайперских, штурмовых винтовок и пистолет-пулемётов получают Зацепляющий ##30см## радиус вокруг траектории полета пули, упрощая попадания.\n\nПосле попадания по врагу, Зацепляющий радиус увеличится на ##30см##, но при этом Зацепляющий урон уменьшится на ##30%##. Каждое последующее попадание будет так же увеличивать радиус и уменьшать урон, но снижение урона остановится при достижении минимального значения - ##20%## от базового урона.\n\nПометки:\n- Если пуля не Зацепит нового врага в течении ##5м## после предыдущего попадания, Зацепляющий радиус полностью исчезнет до конца её полета.\n- Уменьшение урона распространяется только на врагов которых Зацепило увеличенным радиусом - враги в которых пуля попала напрямую всегда получают полный урон оружия.\n- Зацепляющий урон никогда не наносит бонусный урон за попадания в голову.\n- Враги убитые Зацепляющим уроном расцениваются как убийства в тело.\n- Щиты не получают урона от Зацеплений если используемое оружие не имеет возможности пробивать щиты насквозь.\n- Враги находящиеся за стенами не получают урона от Зацеплений если используемое оружие не имеет возможности пробивать стены насквозь.\n\nПРО: ##$pro;##\nБазовый Зацепляющий радиус теперь ##50см##, увеличение радиуса за попадания теперь ##40см##, количество теряемого урона за попадания теперь ##20%##, минимальный возможный урон теперь ##35%##, и Зацепляющий радиус теперь будет исчезать только если пуля никого не Зацепила в течении ##10м## после последнего попадания.",
				})
			end
			Mastermind_str()
			...
			local function Technician_str()
				LocalizationManager:add_localized_strings({
					...
					menu_eco_sentry_beta_desc = "БАЗОВЫЙ: ##$basic;##\nСкорострельность ваших штурмовых винтовок, пистолет-пулеметов и пулеметов увеличена на ##30## выстрелов в минуту.\n\nПРО: ##$pro;##\nСкорострельность ваших штурмовых винтовок, пистолет-пулеметов и пулеметов теперь увеличена на ##150## выстрелов в минуту.",
					...
					menu_heavy_impact_beta = "Ударная волна",
					menu_heavy_impact_beta_desc = "БАЗОВЫЙ: ##$basic##\nПри использовании Пистолет-Пулеметов, Пулеметов, Штурмовых Винтовок и Миниганов в режиме автоматической или очередной стрельбы:\nПри попадании по протвнику вы можете сбивать других противников с ног в радиусе ##2## метров от первичной цели, с ##2.5%## шансом. Шанс проверяется для каждого врага индивидуально, но только ##1## враг может быть сбит с ног за каждое первичное попадание. Шанс повалить врага может быть увеличен за счет статистики подавления вашего оружия.\n\nПометки:\n- Данный навык не распространяется на Бульдозеров, Капитана Винтерса и щитовиков.\n- Множитель подавления: при показателе подавления оружия ##0## ваш множитель подавления равен ##1x##, увеличиавясь вплоть до ##3x## при показателе подавления ##40## или выше.\n\nПРО: ##$pro##\nУвеличивает базовый шанс оглушения до ##7%##, и радиус навыка до ##4## метров.\n\nИспользуя те же шансы, вы теперь можете сбивать клокеров с ног при ##прямом## попадании.",
					menu_fire_control_beta_desc = "БАЗОВЫЙ: ##$basic;##\nВаш ##36## единичный штраф к отдаче во время стрельбы от бедра аннулируется.\n\nПРО: ##$pro;##\nВаш ##20## единичный штраф к точности во время стрельбы от бедра аннулируется.",
					menu_shock_and_awe_beta_desc = "БАЗОВЫЙ: ##$basic;##\nСтрельба на бегу: вы можете стрелять от бедра во время бега.\n\nПРО: ##$pro;##\nПри использовании Пистолет-Пулеметов, Пулеметов, Штурмовых Винтовок и Миниганов в режиме автоматической или очередной стрельбы, или при использовании огнеметов:\n\n- После убийства ##5## противников скорость вашей перезарядки будет увеличена. Минимальный бонус к скорости перезарядки равен ##10%##, и за каждую выстреленную вами пулю перед началом перезарядки данный бонус увеличивается на ##1%##. Максимальный бонус перезарядки данного навыка равен ##125%##.\n- Совершив ##3## попадания по врагам в пределах ##1## секунды, магазин вашего оружия будет пополнен на ##1## пулю, не расходуя ваш общий боезапас.\n\nПометка: После начала перезарядки счетчики убийств и выстреленных пуль сбрасываются. При смене оружия счетчик попаданий сбрасывается.",
					menu_fast_fire_beta_desc = "БАЗОВЫЙ: ##$basic##\nВаши Пистолеты-Пулеметы, Пулеметы и Штурмовые Винтовки получают прибавку в виде ##15## патронов в магазинах.\n\nПРО: ##$pro##\nВы получаете ##25%## шанс пробить вражескую нательную броню.\n\nПробивная подстраховка: если ваш шанс пробить нательную броню успешно сработал вы нанесете полный урон по врагу, но если он не сработает, вы все равно сможете пробить вражескую нательную броню, но с уменьшеным на ##50%## уроном.",
					menu_body_expertise_beta_desc = "БАЗОВЫЙ: ##$basic;##\nПри использовании Пистолет-Пулемётов, Пулемётов, Штурмовых Винтовок и Миниганов в режиме автоматической или очередной стрельбы, либо при использовании Луков, Арбалетов, Огнеметов или пилы OVE9000:\n- При попадании по телу противника вы наносите ##100%## бонусного урона за попадания в голову.\nПометка: Не рапространяется на Бульдозеров.\n\nПРО: ##$pro;##\nПри использовании вышеперечисленных оружий:\n- При попадании по телу противника вы наносите ##125%## бонусного урона за попадания в голову.\n- При попадании в голову противника вы наносите ##125%## бонусного урона за попадания в голову.\nПометка: Не рапространяется на Бульдозеров.\n\nПробивная подстраховка: если ваш шанс пробить нательную броню успешно сработал вы нанесете полный урон по врагу, но если он не сработает, вы все равно сможете пробить вражескую нательную броню, но с уменьшеным на ##50%## уроном.\nПометка: При совмещении с ПРО версией навыка \"Шквальный огонь\" штраф к урону аннулируется.",
				})
			end
			Technician_str()
			...
			local function Ghost_str()
				LocalizationManager:add_localized_strings({
					...
					menu_insulation_beta_desc = "БАЗОВЫЙ: ##$basic##\nКогда ваша броня сломана, первый выстрел по противнику отбросит его назад. Эффект работает до тех пор, пока ваша броня не восстановилась и затем еще ##2## секунды.\n\nПРО: ##$pro##\nКогда тэйзер оглушил вас током, у вас есть ##2## секунды, чтобы вырваться из его плена. После ##2## секунд эффект шока будет автоматически направлен обратно на тэйзера.\n\nЕсли вас ударило током каким-либо образом, ваши пули заряжаются электричеством на ##20## секунд, что позваляет вам оглушать током всех противников, кроме Бульдозера и Капитана Уинтерса, на расстоянии.",
					menu_jail_diet_beta = "Оживленный",
					menu_jail_diet_beta_desc = "БАЗОВЫЙ: ##$basic##\nКогда ваша броня сломана ваш шанс уворота увеличивается на ##15%##. Если ваша броня сломана вы восстановите ##20## единиц брони после удачного уворота, после чего все бонусы данного навыка будут отключены в течении ##45## секунд.\n\nПРО: ##$pro##\nБонус к увороту данного навыка увеличен до ##40%##, восстановление брони увеличено до ##50## единиц, а кулдаун данного навыка уменьшен до ##25## секунд.",
					-- G3
			...
			local function Fugitive_str()
				LocalizationManager:add_localized_strings({
					-- F1
					menu_equilibrium_beta_desc = "БАЗОВЫЙ: ##$basic;##\nУменьшает на ##50%## время, нужное, чтобы достать и убрать пистолеты.\n\nПока вы держите пистолеты в руках вы двигаетесь на ##10%## быстрее.\n\nПРО: ##$pro;##\nВаша точность при использовании пистолетов увеличена на ##16##. Скорость прицеливания с пистолетами ускорена на ##100%##.\n\nВаш ##10%## бонус к скорости передвижения теперь активен если вы имеете пистолет в своем инвентаре, без необходимости держать его в руках.",
					menu_dance_instructor = "Беглые Руки",
					menu_dance_instructor_desc = "БАЗОВЫЙ: ##$basic;##\nВы перезаряжаете пистолеты на ##30%## быстрее.\n\nПРО: ##$pro;##\nПереключение на вторичный пистолет начнет, замедленную на ##150%##, перезарядку вашего убранного на ремень основного оружия.\nПерезярядка оружия на ремне будет отменена если на него переключится до того как перезярядка закончилась.\n\nПри попадании по врагу из вторичного пистолета время перезарядки оружия на ремне сокращается на ##0.2## секунды.",
					menu_gun_fighter_beta = "Однорукий бандит",
					menu_gun_fighter_beta_desc = "БАЗОВЫЙ: ##$basic##\nПопадание из пистолета активирует данный навык на ##5## секунд.\nПока данный навык активен, вы получаете ##32%## бонус к точности с пистолетами.\n\nПРО: ##$pro##\nПока данный навык активен, вы так же получаете ##30%## бонус к урону и ##25%## бонус к скорострельности с пистолетами.\n\nВы самый быстрый стрелок на новом западе.\nВы теперь будете автоматически стрелять из пистолетов в одиночном режиме стрельбы, если вы удерживаете клавишу \"Выстрелить\".",
					...
					menu_martial_arts_beta_desc = "БАЗОВЫЙ: ##$basic##\nПовышает шанс сбить врага с ног рукопашной атакой на ##50%##.\nПри получении урона в ближнем бою тряска камеры и сила отталкивания снижены на ##20%##.\n\nПРО: ##$pro##\nБлагодаря интенсивным тренировкам, вы получаете на ##50%## меньше урона в рукопашном бою.\nПри получении урона в ближнем бою тряска камеры и сила отталкивания теперь снижены на ##75%##.",
					menu_bloodthirst_desc = "БАЗОВЫЙ: ##$basic;##\nПри убийстве врага оружием ближнего боя, скорость вашей перезарядки будет увеличена на ##35%## в течение ##6## секунд.\n\nПРО: ##$pro;##\nКаждый раз, когда вы убиваете врага, урон от оружия ближнего боя будет увеличен на ##40%##. Данный бонус складывается сам с собой вплоть до ##5## раз.\n\nПометка: прибавка к урону работает до тех пор, пока вы не убьёте врага оружием ближнего боя.",
		...
		local function Weapon_strings()
			...
			local function Vanilla_attachs_universal()
				LocalizationManager:add_localized_strings({
					...
					bm_wp_upg_i_burstfire_desc = "Ограничевает режим стрельбы, позволяя использовать только стрельбу очередями из 3 выстрелов, улучшая при этом точность, но уменьшая максимальный урон в секунду.",
					bm_wp_upg_i_burstfire_2rnd_desc = "Ограничевает режим стрельбы, позволяя использовать только стрельбу очередями из 2 выстрелов, улучшая при этом точность, но уменьшая максимальный урон в секунду.",
					bm_wpn_fps_damage_class_update_increase = "Подбор боеприпасов увеличен для соответствия новому классу урона.",
					bm_wpn_fps_damage_class_update_decrease = "Подбор боеприпасов уменьшен для соответствия новому классу урона.",
					bm_wpn_wallbangless_sniper = "Пробивает бронежилеты, врагов и щиты насквозь.",
					bm_wp_upg_lmg_lionbipod_desc_pc = "Позволяет автоматически прилегать к стенам и объектам под 90 и 180 градусами. Если поставить сошки вручную используя клавишу $BTN_BIPOD;, сошки не будут автоматически сниматься при движении.",
				})
			end
			Vanilla_attachs_universal()
			...
			local function Vanilla_attachs_individual()
				LocalizationManager:add_localized_strings({
					...
					bm_wpn_fps_lmg_hcar_barrel_dmr_PEN_desc = "Пробивает нательную броню, щиты, стены и врагов.\nОграничивает режим огня используя только одиночный.\nПодбор боеприпасов уменьшен на 40%.",
					...
					-- Launcher mods
					bm_wpn_fps_upg_a_grenade_launcher_poison_default_desc = "Наносит урон в 6м радиусе, после чего создает 6м облако газа на 15 секунд. Враги попавшие в данное облако поучат отравление вызывающее неконтролируемую рвоту на 11 секунд, блокируя их возможность делать какие либо действия. Враги получают 10 урона в секунду пока они отравлены.\n\nПодбор боеприпасов уменьшен на 70%.",
					bm_wpn_fps_upg_a_grenade_launcher_poison_ms3gl_desc = "Наносит урон в 3м радиусе, после чего создает 6м облако газа на 15 секунд. Враги попавшие в данное облако поучат отравление вызывающее неконтролируемую рвоту на 11 секунд, блокируя их возможность делать какие либо действия. Враги получают 10 урона в секунду пока они отравлены.\n\nПодбор боеприпасов уменьшен на 85%.",
					bm_wpn_fps_upg_a_grenade_launcher_poison_ms3gl_CK_desc = "Наносит урон в 3м радиусе, после чего создает 8м облако газа на 15 секунд. Враги попавшие в данное облако поучат отравление вызывающее неконтролируемую рвоту на 11 секунд, блокируя их возможность делать какие либо действия. Враги получают 10 урона в секунду пока они отравлены.\n\nПодбор боеприпасов уменьшен на 85%.",
					bm_wpn_fps_upg_a_grenade_launcher_poison_underbarrel_desc = "Наносит 860 урона в 6м радиусе, после чего создает 6м облако газа на 15 секунд. Враги попавшие в данное облако поучат отравление вызывающее неконтролируемую рвоту на 11 секунд, блокируя их возможность делать какие либо действия. Враги получают 10 урона в секунду пока они отравлены.\n\nПодбор боеприпасов для подствольного грагатомета уменьшен на 70%.",
					bm_wpn_fps_upg_a_grenade_launcher_poison_arbiter_desc = "Наносит урон в 3м радиусе, после чего создает 4м облако газа на 15 секунд. Враги попавшие в данное облако поучат отравление вызывающее неконтролируемую рвоту на 7 секунд, блокируя их возможность делать какие либо действия. Враги получают 10 урона в секунду пока они отравлены.\n\nПодбор боеприпасов уменьшен на 85%.",
					...
					bm_wpn_fps_upg_snp_awp_conversionkit_new_desc = "Подбор боеприпасов изменен для соответствия новому классу урона.",
					
					-- Flare gun mods
					bm_wp_upg_a_flun_shell_desc = "Стандартные патроны дробовика.\n\nПодбор боеприпасов увеличен дабы компенсировать отсутствие взрывной мощи.",
				})
			end
			Vanilla_attachs_individual()
			...
			local function Custom_Gilza_attachs()
				LocalizationManager:add_localized_strings({
					...
					bm_wpn_fps_upg_pis_mid_ap_rounds_lv_desc = "Пробивает нательную броню, щиты, стены и врагов.\n\nПодбор боеприпасов уменьшен для соответствия новому классу урона и полученым бронебойным способностям.",
					wpn_fps_upg_sub2000_250_dmg_kit = "9x19mm QuakeMaker",
					...
					wpn_fps_upg_shak12_250_dmg_kit = "12.7x55мм ПС12А",
					wpn_fps_upg_shak12_250_dmg_kit_desc = "Специальный патрон с дозвуковой легкой пулей массой 7 грамм с алюминиевым сердечником и двухслойной полуоболочкой, в латунной гильзе.\n\nПодбор патронов увеличен для соответствия новому классу урона.",
					bm_wpn_fps_upg_type54_underbarrel_ammo_pickup_adjuster = "Стандартный пистолетный патрон без 30% штрафа к подбору боеприпасов из-за подствола.",
					bm_wpn_fps_upg_250_smg_ap_kit = "9x19мм ПБП гж",
					bm_wpn_fps_upg_155_smg_ap_kit = "9x19mm AP 6.3",
					bm_wpn_fps_upg_100_smg_ap_kit = "9x19мм Пст гж",
					-- GL section
			...
			local function Weapon_descs()
				LocalizationManager:add_localized_strings({
					...
					bm_w_g36_desc = "Может быть использовано в режиме стрельбы очередью из 2 пуль.",
					bm_w_komodo_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_g3_desc = "Может быть использовано в режиме стрельбы очередью из 2 пуль.",
					bm_w_s552_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_m4_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_groza_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_asval_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_aug_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_scar_desc = "Может быть использовано в режиме стрельбы очередью из 2 пуль.",
					bm_w_beer_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_x_beer_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_hajk_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_x_hajk_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_vityaz_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_x_vityaz_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_mp5_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_x_mp5_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_scorpion_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_x_scorpion_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_mp9_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_x_mp9_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
					bm_w_shepheard_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
			...
			local function Supported_custom_weapons_strings()
				LocalizationManager:add_localized_strings({
					...
					bm_w_crysis3_typhoon_desc = "Альтернативный режим: залп из 10 пуль с увеличенной точностью, способными пробить врагов насквозь.",
					bm_w_hx25_desc = "Стреляет 5 взрывными снарядами, из которых каждый наносит по 150 урона.",
					bm_w_blast_desc = "Стреляет 3 нанитами, из которых каждый наносит по 51 урона.",
					bm_w_g3hk79_desc = "Может быть использовано в режиме стрельбы очередью из 2 пуль.",
					bm_w_kurisumasu_desc = "Может быть использовано в режиме стрельбы очередью из 3 пуль.",
				})
			end
			Supported_custom_weapons_strings()
			...
			local function Custom_attachs_non_Gilza()
				LocalizationManager:add_localized_strings({
					...
					bm_wp_wpn_fps_pis_swhiskey_am_piercing_desc = "Пробивает нательную броню, щиты, стены и врагов. Подбор боеприпасов уменьшен на 40%.",
					-- HX25 Handheld Grenade Launcher
					bm_wp_wpn_fps_upg_hx25_buckshot_ammo_desc = "Патрон с 10 дробинками, позволяющий получать бонусы от навыков для дробовиков.\nМножитель минимального урона с дробовика: 0.8\n\nПодбор боеприпасов увеличен.",
					-- Railgun Rorsch MK-1
					bm_wp_wpn_fps_special_roach_a_sabot_desc = "Двухступенчатый подкалиберный снаряд, похожий на снаряды используемые в современных танках. Имеет скорость полета 3,6 км/сек. Количество накапливаемой энергии приводит к небольшому взрыву в месте попадания.\nОтключает возможность наносить бонусный урон при попадании в голову, и подбирать боезопас.",
					bm_wp_wpn_fps_special_roach_a_thermal_desc = "Используя раннюю теорию эффекта массы, рэйлган может отказаться от использования обычных снарядов и вместо этого использовать кусок тяжелого металла для \"создания\" снарядов размером с песчинку.\nВыстреливает 8 снаярядов, из которых каждый наносит 1500 взывного урона.\nОтключает возможность наносить бонусный урон при попадании в голову, и подбирать боезопас.",
					bm_wp_wpn_fps_special_roach_a_tungsten_desc = "Снаряд с вольфрамовым сердечником, вроде тех, что используются в стрелковом оружии.\nХоть он и перемещаяется с гораздо меньшей скоростью, данный снаряд по-прежнему обладает разрушительной проникающей способностью, но не производит взрыва при ударе.\nПоволяет подбирать боезопас.",
					-- SIG Sauer MCX SPEAR/XM7 NGSW-R
					bm_wp_wpn_fps_ass_mcx_spear_am_default_desc = "Калибр введенный в эксплуатацию после компании NGSW,способный пробить нательную броню, щиты, стены и врагов.\nПодбор боеприпасов уменьшен на 40%.",
					bm_wp_wpn_fps_ass_mcx_spear_am_762_desc = "Уменьшает класс урона оружия и вместе с ним меняет подбор боеприпасов. Не имеет бронебойных способностей.",
					bm_wp_wpn_fps_ass_mcx_spear_am_creedmoor_desc = "Не имеет бронебойных способностей. Подбор боеприпасов раверн стандартному подрбору данного класса урона.",
					bm_wp_wpn_fps_ass_mcx_spear_barrel_marksman_desc = "Отсылка к первоначальной концепции оружия, предусмотренной контрактом CSASS для вооруженных сил США.",
					-- Defiance Blast Rifle
					bm_wp_wpn_fps_upg_blast_ammo_syphon_desc = "Выпускает одиночный заряд с вампирическими нанитами, которые высасывают жизнь из цели с которой они соприкасаются, позволяя пользователю в результате восполнить ее.\n\nПри попадании в живого врага восстанавливает 15% нанесенного урона в виде брони и здоровья, но не чаще чем раз в 1,5 секунды.\nПри попадании в любой другой объект пользователь получает урон по броне и здоровью в размере 3% нанесенного урона.\nПодбор боеприпасов уменьшен на 35%.",
					bm_wp_wpn_fps_upg_blast_ammo_ap_desc = "Чрезвычайно плотные и крайне нестабильные наниты, способные пробивать броню, врагов, стены, щиты и, возможно, вызывать у них рак через 10 лет.\n\nПодбор боеприпасов уменьшен на 40%.",
					bm_wp_wpn_fps_upg_blast_ammo_fire_desc = "Наниты с высокой воспламеняемостью, имеющие 33% вероятность воспламениться при столкновении с броней и тканями, поджигая цель и нанося ей дополнительные 100 единиц урона в течение 2 секунд. Способны пробивать нательную броню и щиты.\n\nПодбор боеприпасов уменьшен на 40%.",
					bm_wp_wpn_fps_upg_blast_ammo_poison_desc = "Биологически опасные наниты, которые разъедают врагов и броню и наполняют цель токсичными веществами, нанося ей дополнительные 160 единиц урона в течение 2 секунд, не позволяя врагам совершать какие-либо действия в течение этого периода.\n\nПодбор боеприпасов уменьшен на 20%.",
					bm_wp_wpn_fps_upg_blast_ammo_stun_desc = "Заряженные наниты, которые при столкновении с целью образуют электрическую цепь, вызывающую сильный электрический разряд, способный оглушить и покалечить большинство врагов, а также поджарить их заживо.\n\nОтключает возможность наносить увеличенный урон при попадании в голову.\nПодбор боеприпасов увеличен на 20%.",
				})
			end
			Custom_attachs_non_Gilza()
		...
		local function UI_strings()
			LocalizationManager:add_localized_strings({
				...
				Gilza_BTAW_warning_str = "Был найден мод \"Bipods that work\" - пожалуйста, удалите его дабы мод Gilza нормально работал.",
				Gilza_LMG_STEELSIGHTS_warning_str = "Был найден мод \"LMG Steelsights\" - пожалуйста, удалите его дабы мод Gilza нормально работал.",
				-- armor based ammo pick up description
				bm_menu_armor_pickup_desc = "Множитель подбора боезапаса и метательного оружия: $amount;",
				-- VHUD compatibility with burst warning
				...
				-- VHUD compatibility for buffinfo
				Gilza_new_skill_zerk_weapons = "Оружия",
				Gilza_new_skill_zerk_melee = "Ближ. бой",
				Gilza_new_skill_stockholm_basic = "Запуг.",
				Gilza_new_skill_body_economy = "Перезар.",
				Gilza_new_skill_unseen_strike_eligibility = "В праве",
				Gilza_new_skill_unseen_strike_crits = "Криты",
				Gilza_new_skill_offhand_reload_duration = "На ремне",
				wolfhud_hudlist_dire_need_buff_desc = "This option is configurable by Gilza, and is now part of \"Backfire\" basic skill. Please go to Gilza's mod options to adjust it.",
				wolfhud_hudlist_lock_n_load_buff_desc = "This option is now only configurable by Gilza. Please go to Gilza's mod options to adjust this option.",
				wolfhud_hudlist_unseen_strike_buff_desc = "This option is now only configurable by Gilza. Please go to Gilza's mod options to adjust this option.",
				wolfhud_hudlist_buff_dmg_dec = "Сопр.",
				Gilza_new_vhud_dmg_aborb_total = "Поглощ.",
				wolfhud_hudlist_buff_tot_dodge = "Уворот",
				Gilza_new_hitman_recovery_bonus_tag = "Востанов.",
			})
		end
		UI_strings()
		...
		local function Additional_fix_strings()
			LocalizationManager:add_localized_strings({
				...
				menu_frenzy_desc = "БАЗОВЫЙ: ##$basic;##\nТеперь у вас только ##30%## от максимального запаса здоровья и вы не сможете восполнить его выше этой отметки. Вы получаете ##10%## сопротивления урону.\n\nНавыки восполняеющие ваше здоровье теперь восполняют на ##75%## меньше здоровья.\n\nПРО: ##$pro;##\nВаше сопротивление урону от данного навыка теперь равно ##25%##. Навыки восполняющие ваше здоровье теперь восполняют здоровье в полной силе.",
				-- PERKS
	...
	if chosen_language == "eng" then
		loc:load_localization_file(Gilza._path .. 'menus/lang/Gilza_en.json', false)
	elseif chosen_language == "ru" then
		loc:load_localization_file(Gilza._path .. 'menus/lang/Gilza_ru.json', false)
		AddRussianLoc()
	end
