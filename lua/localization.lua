Hooks:Add('LocalizationManagerPostInit', 'Gilza_localizations', function(loc)
	...
	local function AddEnglishLoc()
		...
		LocalizationManager:add_localized_strings({
			...
			-- Vanilla decks
			-- crew chief
			menu_deck1_3_desc = "You and your crew's stamina is increased by ##50%##.\n\nWhile trying to intimidate a law enforcer, or using Inspire skill on your teammates, your shout distance is increased by ##25%##.\n\nWhile you are within ##18m## of an enemy, you receive a ##8%## damage reduction. This damage reduction lingers for ##5## seconds after you are no longer close to an enemy.\nNote: Crew perks do not stack.",
			...
			menu_deck1_9_desc = "You and your crew will gain ##6%## max health and ##12%## stamina for each hostage up to ##4## times.\n\nYou and your crew will gain ##8%## damage reduction for having one or more hostages.\n\nIntimidated law eforcers count as hostages for this perk card. Enemies who were converted to fight on your side will provide hostage bonuses from this perk card only to the crew member who converted such enemy.\n\nNote: Crew perks do not stack.\n\nDeck Completion Bonus: Your chance of getting a higher quality item during a Payday is increased by ##10%##.",
			-- muscle
			menu_deck2_7_desc = "All firearms, that do dont have a silencer equipped, have a ##20%## chance to spread panic among your enemies.\n\nPanic will make enemies go into short bursts of uncontrollable fear.",
			...
			-- rogue
			menu_deck4_3_desc = "You are ##15## less likely to be targeted when you are close to your crew members.\n\nThis bonus is applied as a ##0.85## multiplier after all other attention related skills.",
			menu_deck4_9_desc = "Your chances to pierce enemy body armor are incresed by ##40%##.\nIncreases weapon swapping speed by ##80%##.\n\nYour chance to dodge is increased by an additional ##5%##.\nYour chance to dodge while crouched is increased by ##5%##.\nYour movement speed is increased by ##15%##.\nYour stamina is increased by ##25%##.\n\nDeck Completion Bonus: Your chance of getting a higher quality item during a Payday is increased by ##10%##.",
			-- hitman
			menu_deck5_1 = "Master of arms",
			menu_deck5_1_desc = "Securing a kill with a melee weapon or a throwable non-explosive weapon regenerates ##50%## of your armor. This can not happen more often than once every ##2## seconds.",
			menu_deck5_3_desc = "Akimbo weapons have a ##-8## stability penalty.\nAmmo capacity for your akimbo weapons is increased by ##50%##.\n\nKilling an enemy using a pistol, SMG or akimbo weapon grants you ##25%## faster armor recovery rate for ##10## seconds. If you secure a kill with a pistol, SMG or akimbo weapon while this skill is already active, skill duration timer we be refreshed.",
			menu_deck5_5 = "Rhythm of Death",
			menu_deck5_5_desc = "\nNew ability: Rhythm of Death.\nTo activate, you need to secure ##4## combo kills in a row. Time between each kill can not be less then ##0.5## seconds and can not be more then ##1.5## seconds. If you secure a kill faster then required, the kill is ignored for the combo; if you are too late, combo is reset.\n\nFirst kill of the combo must be achieved using either a melee weapon or a throwable non-explosive weapon. To activate the ability you need to secure at least ##2## kills with melee or throwable non-explosive weapons during the combo.\n\nOn ability activation: gain ##8## seconds of invlunerability. This effect has a cooldown of ##20## seconds.\n\nGilza's perk UI will show you your current combo amount, if invlunerability is active (blue skull), and if it is on cooldown (red timer).",
			menu_deck5_7 = "Bounty Hunter",
			menu_deck5_7_desc = "\nNew passive trait: Bounty Hunter.\nRandom enemy within ##25m## of you becomes your bounty target, this target will get a white outline visible only to you. If you kill your bounty you gain a bounty bonus.\n\nBounty bonus lasts for ##25## seconds. After bounty bonus duration expires, you would not be able to receive a new bounty for ##15## seconds. If your bounty target escapes or is killed by someone else, you don't get a bounty bonus and you would not be able to receive a new bounty for ##40## seconds.\n\nBounty bonus:\nWhile active, amplifies effects of Hitman's perk cards 1, 3 and 5.\nFirst card's armor regeneration is increased to ##100%##, third card's armor recovery bonus is increased to ##50%##, and fifth card's invulnerability duration is increased to ##16## seconds, without affecting the cooldown.\n\nGilza's perk UI will show you if you currently have a bounty (bright white), and if bounty bonus is active (green).",
			...
			menu_sociopathinfil_1_desc = "While you are surrounded by three or more enemies within ##18m## of you, you receive a ##12%## damage reduction. This damage reduction lingers for ##5## seconds after you are no longer surrounded.\n\nYour second and each consecutive melee hit within ##4## seconds of the last one will deal ##100%## more damage.\n",
			-- socio
			...
			menu_deck8_3_desc = "While you are within ##18m## of an enemy, you receive a ##8%## damage reduction. This damage reduction lingers for ##5## seconds after you are no longer close to an enemy.",
			menu_deck8_5 = "Advanced Close Combat",
			menu_deck8_5_desc = "While you are within ##18m## of an enemy, you receive an additional ##8%## damage reduction. This damage reduction lingers for ##5## seconds after you are no longer close to an enemy.",
			menu_deck8_7 = "Expert Close Combat",
			menu_deck8_7_desc = "While you are within ##18m## of an enemy, you receive an additional ##8%## damage reduction. This damage reduction lingers for ##5## seconds after you are no longer close to an enemy.",
			-- grinder
			menu_deck11_5_desc = "Damaging an enemy now heals ##3## life points every ##0.3## seconds for ##3## seconds.\n\nYour chances to pierce enemy body armor are incresed by ##10%##.",
			menu_deck11_9_desc = "Damaging an enemy now heals ##4## life points every ##0.3## seconds for ##4.2## seconds.\n\nYour chances to pierce enemy body armor are incresed by additional ##25%##.\n\nDeck Completion Bonus: Your chance of getting a higher quality item during a Payday is increased by ##10%##.",
			-- sicario
			...
			menu_deck12_9_desc = "All berserker state effects in this perk deck will start at ##50%## health instead of ##25%##.\n\nEntering berserker state makes you immune to armor piercing and armor suppression effects.\n\nNote: normally, armor suppression effect is applied to you whenever you are shot, regardless of if you are hit or not. If you get supressed, your armor recovery timer will be set to it's maximum duration and then extended by ##1## second. This timer extension can not be reduced by armor recovery or any other skills.\nArmor suppression immunity effect from this perk card reduces this timer extension to ##0.75## seconds, or ##0.3## seconds if played on Death Sentence difficulty, as well as allows you to recover armor even while being under fire.\n\nDeck Completion Bonus: Your chance of getting a higher quality item during a Payday is increased by ##10%##.",
			-- maniac
			menu_deck14_1_desc = "##100%## of damage you deal is converted into Hysteria Stacks, up to ##120## every ##1.5## second. Max amount of stacks is ##600##.\n\nHysteria Stacks\nYou gain ##1## damage absorption for every ##30## stacks of Hysteria.\nIf you don't deal any damage for ##3## seconds, you will loose ##20% + 80## Hysteria Stacks.",
			...
			menu_deck5_1_desc_short = "When you receive damage while recovering armor, your armor recovery timer will pause for a brief duration instead of resetting to it's maximum duration.\nYour armor recovery rate is increased by ##5%##.\n\n",
			...
			menu_deck_brawler7_desc = "While you are under ##50%## health, you gain ##4%##  bullet damage resistance for your armor and ##2.5## damage absorption for every teammate within ##24m## from you.\nConverted enemies count as a teammate for this mechanic.\nWhile playing on Death Sentence difficulty, defensive bonuses from this perk card are increased to ##8%## damage resistance and ##10## damage absorption per teammate.\n\nYou are ##15%## more likely to be targeted when you are close to your crew members. All other skills that adjust your likelihood of being targeted are now ignored.\n\nNote: Gilza's perk UI will show you how many teammates you currently have around you: icon will be faded out for 0 players, colored white for 1, yellow for 2, and green for 3.",
			...
			menu_deck_brawler1_desc_short = "Your ammo capacity and pick up rate are reduced by ##80%##. Your armor recovery rate is reduced by ##300%##. Your armor has ##5%## bullet damage resistance.",
			menu_deck_brawler3_desc_short = "Your armor has ##10%## more bullet damage resistance. Armor movement speed penalty is reduced by ##25%##.",
			menu_deck_brawler5_desc_short = "Your armor is now immune to AP effects. Your armor has ##10%## more bullet damage resistance. Armor movement penalty is reduced by additional ##25%##. Melee kills restore ##5%## of your stamina.",
			menu_deck_brawler7_desc_short = "You are ##100%## more likely to be targeted when you are close to your crew members. While you are under ##50%## health, enemies will deal less damage to you, reductions depend on amount of crew members in close proximity.",
			menu_deck_brawler9_desc_short = "Melee kills grant armor regeneration over a shoty period. You can have up to ##3## armor regeneration effects from this perk card at the same time.",
			...
			menu_deck_Gilza_guardian_desc = "Guardian. A true defender.\nAll the heisting experience you've gathered over the years led you to a simple, yet truthful conclusion - the better you can defend that 'broke dick piece of shit drill', the faster you will get to the riches that it's trying to uncover, and to the escape van after all the goodies are in the bag. And now that you have learned all the defensive techniques you could, you have become the wall. No match for any force that tries to move you. If only you didn't forget a few things along the learning way...",
			...
			menu_deck_Gilza_guardian_7_desc_short = "You can now automatically mirror back damage at enemies, higher armor provides higher chances. Passive activation of the defense area takes less time.",
		...
		LocalizationManager:add_localized_strings({
			...
			-- Enforcer
			-- E1
			menu_underdog_beta_desc = "BASIC: ##$basic;##\nWhile you are surrounded by three or more enemies within ##18m## of you, you receive a ##10%## damage bonus. This bonus lingers for ##5## seconds after you are no longer surrounded.\n\nACE: ##$pro;##\nWhile you are surrounded by three or more enemies within ##18m## of you, you also receive a ##10%## damage reduction. This damage reduction lingers for ##5## seconds after you are no longer surrounded.\n\nNote: Does not apply to melee damage, throwables, grenade launchers or rocket launchers.",
			...
			-- G3
			menu_silence_expert_beta_desc = "BASIC: ##$basic;##\nYou gain ##8## weapon stability and ##100%## snap to zoom speed increase with silenced weapons.\n\nYour chances to pierce enemy body armor are incresed by ##15%## while using silenced weapons.\n\nACE: ##$pro;##\nYou gain ##12## weapon accuracy with silenced weapons.\n\nYour chances to pierce enemy body armor are incresed by additional ##35%## while using silenced weapons.",
			...
			menu_gun_fighter_beta_desc = "BASIC: ##$basic##\nEach successful pistol hit gives you a ##32%## increased accuracy bonus for ##10## seconds and can stack ##1## times.\n\nACE: ##$pro##\nEach successful pistol hit gives you a ##75%## damage boost for ##10## seconds and can stack ##1## times.",
	...
	local function AddRussianLoc()
		...
		LocalizationManager:add_localized_strings({
			...
			menu_deck5_1_desc = "Получение урона во время регенерации брони отныне будет ставить таймер регенерации брони на паузу вместо сброса таймера до максимального значения.\n\nПродолжительность паузы составляет ##25%## максимальной продолжительности регенерации брони, но она может быть сокращена если продолжительность регенерации брони вместе с паузой превосходит стандартную продолжительность регенерации.\n\nВремя восстановления брони уменьшено на ##5%##.\n\n",
