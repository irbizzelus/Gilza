Hooks:Add('LocalizationManagerPostInit', 'Gilza_localizations', function(loc)
	...
	local function AddEnglishLoc()
		...
		LocalizationManager:add_localized_strings({
			...
			-- Vanilla decks
			menu_deck1_3_desc = "You and your crew's stamina is increased by ##50%##.\n\nIncreases your shout distance by ##25%##.\n\nWhile you are within ##18m## of an enemy, you receive a ##8%## damage reduction. This damage reduction lingers for ##3## seconds after you are no longer close to an enemy.\nNote: Crew perks do not stack.",
			...
			menu_sociopathinfil_1_desc = "While you are surrounded by three or more enemies within ##18m## of you, you receive a ##12%## damage reduction. This damage reduction lingers for ##3## seconds after you are no longer surrounded.\n\nYour second and each consecutive melee hit within ##4## seconds of the last one will deal ##100%## more damage.\n",
			...
			menu_deck8_1_desc = "While you are within ##18m## of an enemy, you receive a ##8%## damage reduction. This damage reduction lingers for ##3## seconds after you are no longer close to an enemy.",
			menu_deck8_3_desc = "While you are within ##18m## of an enemy, you receive an additional ##8%## damage reduction. This damage reduction lingers for ##3## seconds after you are no longer close to an enemy.",
			...
			-- maniac
			menu_deck14_1_desc = "##100%## of damage you deal is converted into Hysteria Stacks, up to ##80## every ##1## second. Max amount of stacks is ##600##.\n\nHysteria Stacks\nYou gain ##1## damage absorption for every ##30## stacks of Hysteria.\nIf you don't deal any damage for ##2## seconds, you will loose ##10% + 100## Hysteria Stacks.",
			menu_deck14_5_desc = "Change decay of your Hysteria Stacks when you don't deal damage for ##2## seconds to ##10% + 50##.",
		...
		LocalizationManager:add_localized_strings({
			...
			-- Enforcer
			-- E1
			menu_underdog_beta_desc = "BASIC: ##$basic;##\nWhile you are surrounded by three or more enemies within ##18m## of you, you receive a ##10%## damage bonus. This bonus lingers for ##3## seconds after you are no longer surrounded.\n\nACE: ##$pro;##\nWhile you are surrounded by three or more enemies within ##18m## of you, you also receive a ##10%## damage reduction. This damage reduction lingers for ##3## seconds after you are no longer surrounded.\n\nNote: Does not apply to melee damage, throwables, grenade launchers or rocket launchers.",
