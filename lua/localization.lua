		...
		local function Perk_strings_vanilla()
			...
			local function Rogue_str()
				LocalizationManager:add_localized_strings({
					...
					-- short descs
					menu_deck4_9_short = "You gain ##40%## chance to pierce enemy body armor. Increases weapon swapping speed by ##80%##. Your chance to dodge is increased by ##5%## and your chance to dodge while crouched is increased by ##5%##. Your movement speed is increased by ##15%##. Your stamina is increased by ##25%##.",
				})
			end
			Rogue_str()
