Hooks:Add('LocalizationManagerPostInit', 'Gilza_localizations', function(loc)
	...
	local function AddEnglishLoc()
		...
		LocalizationManager:add_localized_strings({
			...
			-- socio
			menu_deck8_1_desc = "While you are within ##18m## of an enemy, you receive a ##8%## damage reduction. This damage reduction lingers for ##5## seconds after you are no longer close to an enemy.",
			menu_deck8_3_desc = "While you are within ##18m## of an enemy, you receive an additional ##8%## damage reduction. This damage reduction lingers for ##5## seconds after you are no longer close to an enemy.",
			-- sicario
