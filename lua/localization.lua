Hooks:Add('LocalizationManagerPostInit', 'Gilza_localizations', function(loc)
	...
	local function AddEnglishLoc()
		...
		LocalizationManager:add_localized_strings({
			...
			menu_deck5_1_desc = "When you receive damage while recovering armor, your armor recovery timer will pause for a brief duration instead of resetting to it's maximum duration.\n\nRecovery pause lasts for ##25%## of your maximum armor recovery time, unless it would exceed your total armor recovery beyond the maximum, in which case it is reduced.\n\nYour armor recovery rate is increased by ##5%##.\n\n",
