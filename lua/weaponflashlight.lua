Hooks:PostHook(WeaponFlashLight, "update", "Gilza_WeaponFlashLight_update_post", function(self, unit, t, dt)
	if not self._is_npc and not self:is_haunted() then
		...
		self._light:set_spot_angle_end(69)
...
Hooks:PostHook(WeaponFlashLight, "init", "Gilza_WeaponFlashLight_init_post", function(self, unit)
	if not self._is_npc and not self:is_haunted() then
		...
		self._light_drop_off_2:set_spot_angle_end(69)
		self._light_drop_off_2:set_far_range(1600)
		self._light_drop_off_2:set_multiplier(self._current_light_multiplier * 0.75)
		...
		self._light_drop_off_3:set_spot_angle_end(69)
		self._light_drop_off_3:set_far_range(2800)
		self._light_drop_off_3:set_multiplier(self._current_light_multiplier * 0.5)
		...
		self._light_drop_off_4:set_spot_angle_end(69)
		self._light_drop_off_4:set_far_range(4000)
		self._light_drop_off_4:set_multiplier(self._current_light_multiplier * 0.25)
