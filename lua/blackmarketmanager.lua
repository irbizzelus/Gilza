...
-- this func updates blackmarket GUI numbers; @11-33
...
-- this func actually adds the stat to the gun; @67-89
...
-- same as 2 funcs above but for recoil - updates both GUI and the stats; @119-136
