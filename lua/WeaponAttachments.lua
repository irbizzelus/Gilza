...
Hooks:PostHook(WeaponFactoryTweakData, "init", "Gilza_weapon_attachments_data", function(self, ...)
	...
	local function init_new_mods()
		...
		self.parts.wpn_fps_upg_c96_ap_kit_ap_rounds.custom_stats = {
			armor_piercing_add = 1,
			can_shoot_through_shield = true,
		...
		self.parts.wpn_fps_upg_contraband_762_to_556_kit.custom_stats = {
			ammo_pickup_max_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("AR", 450, 200).max_mul,
			ammo_pickup_min_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("AR", 450, 200).min_mul
		}
		...
		self.parts.wpn_fps_upg_ak_hp_rounds.stats = {value = 0,damage = 200,spread = -2,recoil = -3,total_ammo_mod = -8}
		self.parts.wpn_fps_upg_ak_hp_rounds.custom_stats = {
		...
		self.parts.wpn_fps_upg_m4_hp_rounds.stats = {value = 0,damage = 95,spread = -4,recoil = -3,total_ammo_mod = -3.33}
		self.parts.wpn_fps_upg_m4_hp_rounds.custom_stats = {
			ammo_pickup_max_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("AR", 155, 250).max_mul,
			ammo_pickup_min_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("AR", 155, 250).min_mul
		}
		...
		self.parts.wpn_fps_upg_groza_762_to_545_kit.stats = {value = 0,total_ammo_mod = 5,damage = -95,spread = -2,recoil = 4}
		self.parts.wpn_fps_upg_groza_762_to_545_kit.custom_stats = {
			ammo_pickup_max_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("AR", 250, 155).max_mul,
			ammo_pickup_min_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("AR", 250, 155).min_mul
		}
		...
		self.parts.wpn_fps_upg_fal_sp_rounds.custom_stats = {
		...
		-- amcar's 125 damage profile kit
		...
		self.parts.wpn_fps_upg_amcar_rrlp_rounds.stats = {value = 0,damage = -75,spread = 1,recoil = 5,total_ammo_mod = 6.67}
		self.parts.wpn_fps_upg_amcar_rrlp_rounds.custom_stats = {
			ammo_pickup_max_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("AR", 200, 125).max_mul,
			ammo_pickup_min_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("AR", 200, 125).min_mul
		}
		...
		self.parts.wpn_fps_gre_ms3gl_ml_double_round.stats = {reload = -2, recoil = 2, spread = 1}
	...
	local function init_general_mods()
		...
		local function general_MD()
			...
			self.parts.wpn_fps_upg_pis_ns_flash.stats.suppression = -10
		...
		local function general_barrels()
			...
			self.parts.wpn_fps_upg_ass_ak_b_zastava.desc_id = self.parts.wpn_fps_upg_ap_kit_ap_rounds.desc_id
			...
			self.parts.wpn_fps_upg_ass_m4_b_beowulf.desc_id = self.parts.wpn_fps_upg_ap_kit_ap_rounds.desc_id
		...
		local function general_foregrips()
			...
			self.parts.wpn_upg_ak_fg_combo3.stats.recoil = 4
			self.parts.wpn_upg_ak_fg_combo3.stats.reload = 4
			self.parts.wpn_upg_ak_fg_combo3.stats.concealment = -3
	...
	local function init_AR_mods()
		...
		local function Gilza_init_famas()
			...
			self.parts.wpn_fps_ass_famas_b_sniper.desc_id = self.parts.wpn_fps_upg_ap_kit_ap_rounds.desc_id
		...
		local function Gilza_init_g3()
			...
			self.parts.wpn_fps_ass_g3_b_sniper.desc_id = self.parts.wpn_fps_upg_ap_kit_ap_rounds.desc_id
			-- assault kit
			...
			self.parts.wpn_fps_ass_g3_b_short.custom_stats = {
				...
				ammo_pickup_max_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("AR", 250, 200).max_mul,
				ammo_pickup_min_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("AR", 250, 200).min_mul
			}
	...
	local function init_Shotgun_mods()
		...
		local function init_shotgun_ammo()
			...
			-- FIRE
			self.parts.wpn_fps_upg_a_dragons_breath.stats = {value = 5,total_ammo_mod = -6.66,recoil = -6}
			...
			self.parts.wpn_fps_upg_a_rip.custom_stats.can_shoot_through_enemy = true
			self.parts.wpn_fps_upg_a_rip.custom_stats.knock_down_chance = 1
			self.parts.wpn_fps_upg_a_rip.desc_id = "bm_wpn_fps_upg_a_rip_desc_new"
			
			-- HE SLUG
			local HE_custom_stats = { -- dont forget to update for custom shotguns in weapontweaks as well
			...
			-- BUCKSHOT
			local BS_custom_stats = { -- dont forget to update for custom shotguns in weapontweaks as well
				damage_far_mul = 0.75,
		...
		local function Gilza_init_r870()
			...
			self.parts.wpn_fps_shot_r870_body_rack.stats.total_ammo_mod = 2.78
			...
			self.parts.wpn_fps_shot_r870_fg_wood.stats.spread = -6
		...
		local function Gilza_init_saiga()
			self.parts.wpn_fps_sho_basset_m_extended.stats.reload = -4
		...
		local function Gilza_init_supernova()
			self.parts.wpn_fps_sho_supernova_shell_rack.stats.total_ammo_mod = 3.33
		...
		local function Gilza_init_b682()
			self.parts.wpn_fps_shot_b682_s_ammopouch.stats.total_ammo_mod = 8
		end
		Gilza_init_b682()
		...
		local function Gilza_init_aa12()
			...
			self.parts.wpn_fps_sho_aa12_mag_drum.stats.reload = -5
		...
		local function Gilza_init_serbu()
			self.wpn_fps_shot_serbu.override = self.wpn_fps_shot_serbu.override or {}
			self.wpn_fps_shot_serbu.override.wpn_fps_shot_r870_body_rack = {stats = {value = 3,reload = 1,concealment = -3,total_ammo_mod = 4.17}}
		end
		Gilza_init_serbu()
		...
		local function Gilza_init_ultima()
			self.parts.wpn_fps_sho_ultima_body_rack.stats.total_ammo_mod = 3.57
		end
		Gilza_init_ultima()
	...
	local function init_LMG_mods()
		...
		self.parts.wpn_fps_lmg_m60_fg_tropical.stats.recoil = 6
		self.parts.wpn_fps_lmg_m60_fg_keymod.stats.spread = 1
		self.parts.wpn_fps_lmg_m60_fg_keymod.stats.recoil = -1
		...
		self.parts.wpn_fps_lmg_kacchainsaw_conversionkit.stats = {extra_ammo = 50,damage = -25,value = 1,spread = 6,recoil = 5,total_ammo_mod = 8.57}
		self.parts.wpn_fps_lmg_kacchainsaw_conversionkit.custom_stats = {
			fire_rate_multiplier = 1.25,
			ammo_pickup_max_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("LMG", "125_bipodless", "100_bipodless").max_mul,
			ammo_pickup_min_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("LMG", "125_bipodless", "100_bipodless").min_mul
		}
		...
		self.parts.wpn_fps_lmg_hcar_barrel_dmr.desc_id = self.parts.wpn_fps_upg_ap_kit_ap_rounds.desc_id
		self.parts.wpn_fps_lmg_hcar_barrel_dmr.forbids = {"wpn_fps_lmg_hcar_m_drum"}
		self.parts.wpn_fps_lmg_hcar_body_conversionkit.stats = {extra_ammo = 40,total_ammo_mod = 10,damage = -50,value = 1,spread = -7,recoil = 7,fire_rate = 1.5,reload = -6}
		...
		-- soundfix
		self.parts.wpn_fps_lmg_hcar_ck_switch.custom_stats = {
			sounds = {
				fire = "hcar_fire_single",
				fire_single = "hcar_fire_single",
		...
		self.parts.wpn_fps_lmg_mg42_b_mg34.stats.recoil = -3
		self.parts.wpn_fps_lmg_mg42_b_mg34.stats.spread = 1
		self.parts.wpn_fps_lmg_mg42_b_mg34.stats.concealment = 4
	...
	local function init_SMG_mods()
		...
		local function Gilza_init_hajk()
			...
			self.wpn_fps_smg_x_hajk.override.wpn_fps_upg_m4_m_quad = {override_weapon = {_meta = "override_weapon",CLIP_AMMO_MAX = 120},stats = {concealment = -5,recoil = 4,value = 3,reload = -6,spread = -3}}
	...
	local function init_Special_mods()
		...
		-- M32
		self.parts.wpn_fps_gre_m32_barrel_short.stats.spread = -3
		self.parts.wpn_fps_gre_m32_barrel_short.stats.recoil = 3
		...
		self.parts.wpn_fps_gre_ms3gl_conversion.stats.total_ammo_mod = -13.33
		...
		self.parts.wpn_fps_upg_a_grenade_launcher_poison.stats.total_ammo_mod = -13.33
		...
		self.parts.wpn_fps_upg_a_grenade_launcher_poison_ms3gl.custom_stats.ammo_pickup_min_mul = 0.15
		self.parts.wpn_fps_upg_a_grenade_launcher_poison_ms3gl.custom_stats.ammo_pickup_max_mul = 0.15
		self.parts.wpn_fps_upg_a_grenade_launcher_poison_ms3gl.stats.total_ammo_mod = -13.33
		...
		self.parts.wpn_fps_gre_ms3gl_conversion_grenade_poison.custom_stats.ammo_pickup_min_mul = 0.15
		self.parts.wpn_fps_gre_ms3gl_conversion_grenade_poison.custom_stats.ammo_pickup_max_mul = 0.15
		self.parts.wpn_fps_upg_a_grenade_launcher_poison_arbiter.stats = {}
		self.parts.wpn_fps_upg_a_grenade_launcher_poison_arbiter.custom_stats.ammo_pickup_min_mul = 0.15
		self.parts.wpn_fps_upg_a_grenade_launcher_poison_arbiter.custom_stats.ammo_pickup_max_mul = 0.15
		self.parts.wpn_fps_upg_a_grenade_launcher_poison_arbiter.stats.total_ammo_mod = -13.33
		...
		-- electric
		self.parts.wpn_fps_upg_a_grenade_launcher_electric.custom_stats.ammo_pickup_min_mul = 1.2
		self.parts.wpn_fps_upg_a_grenade_launcher_electric.custom_stats.ammo_pickup_max_mul = 1.2
		self.parts.wpn_fps_upg_a_grenade_launcher_electric.desc_id = "bm_wpn_fps_upg_a_grenade_launcher_electric_desc"
		self.parts.wpn_fps_upg_a_grenade_launcher_electric_arbiter.custom_stats.ammo_pickup_min_mul = 1.2
		self.parts.wpn_fps_upg_a_grenade_launcher_electric_arbiter.custom_stats.ammo_pickup_max_mul = 1.2
		self.parts.wpn_fps_upg_a_grenade_launcher_electric_arbiter.desc_id = "bm_wpn_fps_upg_a_grenade_launcher_electric_desc"
		self.parts.wpn_fps_upg_a_grenade_launcher_electric_ms3gl.custom_stats.ammo_pickup_min_mul = 1.2
		self.parts.wpn_fps_upg_a_grenade_launcher_electric_ms3gl.custom_stats.ammo_pickup_max_mul = 1.2
		self.parts.wpn_fps_upg_a_grenade_launcher_electric_ms3gl.desc_id = "bm_wpn_fps_upg_a_grenade_launcher_electric_desc"
		self.parts.wpn_fps_upg_a_underbarrel_electric.custom_stats.ammo_pickup_min_mul = 1.2
		self.parts.wpn_fps_upg_a_underbarrel_electric.custom_stats.ammo_pickup_max_mul = 1.2
		-- shotgun round
		local gl_overrides = {
			"wpn_fps_gre_arbiter",
			"wpn_fps_gre_china",
		...
		for _, GL in pairs(gl_overrides) do
			self[tostring(GL)].override.wpn_fps_upg_a_grenade_launcher_hornet.custom_stats.ammo_pickup_min_mul = 2.5
			self[tostring(GL)].override.wpn_fps_upg_a_grenade_launcher_hornet.custom_stats.ammo_pickup_max_mul = 2.5
			self[tostring(GL)].override.wpn_fps_upg_a_grenade_launcher_hornet.custom_stats.can_shoot_through_enemy = true
			self[tostring(GL)].override.wpn_fps_upg_a_grenade_launcher_hornet.custom_stats.armor_piercing_add = 1
			self[tostring(GL)].override.wpn_fps_upg_a_grenade_launcher_hornet.custom_stats.sounds = nil
			self[tostring(GL)].override.wpn_fps_upg_a_grenade_launcher_hornet.stats.spread = -6
			self[tostring(GL)].override.wpn_fps_upg_a_grenade_launcher_hornet.stats.total_ammo_mod = 5
			self[tostring(GL)].override.wpn_fps_upg_a_grenade_launcher_hornet.stats.reload = 4
		end
		...
		self.wpn_fps_ass_groza.override.wpn_fps_upg_a_underbarrel_hornet = {
			custom_stats = {
					...
					base_stats_modifiers = {spread = -10,damage = -155},
		...
		self.wpn_fps_ass_contraband.override.wpn_fps_upg_a_underbarrel_hornet = {
			custom_stats = {
					...
					ammo_pickup_min_mul = 5.5,
					ammo_pickup_max_mul = 5.5,
					base_stats_modifiers = {spread = -10,damage = -51},
					falloff_override = {near_falloff = 0,optimal_range = 100,optimal_distance = 100,near_multiplier = 1,far_multiplier = 1,far_falloff = 100},
					can_shoot_through_shield = true,
					armor_piercing_add = 1, -- {fire_single = "hornet_fire"},
					can_shoot_through_enemy = true,
					muzzleflash = "effects/payday2/particles/weapons/shotgun/sho_muzzleflash_hornet",
					ignore_damage_upgrades = false,
			},
	...
	local function init_Pistol_mods()
		...
		local function Gilza_init_colt_1911()
			...
			self.parts.wpn_fps_pis_1911_m_big.stats.spread = -2
			self.parts.wpn_fps_pis_1911_m_extended.stats.reload = -3
			self.parts.wpn_fps_pis_1911_m_extended.stats.recoil = 1
			self.parts.wpn_fps_pis_1911_m_extended.stats.spread = -1
	...
	local function init_Sniper_mods()
		...
		self.parts.wpn_fps_snp_sbl_s_saddle.stats.total_ammo_mod = 2
		...
		self.parts.wpn_fps_snp_awp_conversion_dragonlore.custom_stats = {
			ammo_pickup_max_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("SNIPER", 1300, 1600).max_mul,
			ammo_pickup_min_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("SNIPER", 1300, 1600).min_mul
		}
		...
		self.parts.wpn_fps_snp_awp_conversion_wildlands.stats.total_ammo_mod = 4
		self.parts.wpn_fps_snp_awp_conversion_wildlands.stats.damage = -350
		self.parts.wpn_fps_snp_awp_conversion_wildlands.stats.reload = -4
		self.parts.wpn_fps_snp_awp_conversion_wildlands.custom_stats = {
			ammo_pickup_max_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("SNIPER", 1300, 950).max_mul,
			ammo_pickup_min_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("SNIPER", 1300, 950).min_mul,
		...
		self.parts.wpn_fps_snp_contender_conversion.stats.total_ammo_mod = -7.14
		self.parts.wpn_fps_snp_contender_conversion.stats.damage = 300
		self.parts.wpn_fps_snp_contender_conversion.custom_stats = {
			ammo_pickup_max_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("SNIPER", 1300, 1600).max_mul,
			ammo_pickup_min_mul = G_W_M:get_pickup_adjusments_for_wpn_mod("SNIPER", 1300, 1600).min_mul
		}
		...
		local function FrenchyAU_packs_stat_adjustments()
			...
			local function FrenchyAU_stocks()
				...
				if self.parts.wpn_fps_upg_m4_s_viper then
					...
					self.parts.wpn_fps_upg_m4_s_viper.stats.reload = 4
				end
